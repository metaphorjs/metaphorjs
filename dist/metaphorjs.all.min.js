...
MetaphorJs.lib.Watchable.create,Ga=MetaphorJs.ns.register,Z=MetaphorJs.toArray=function(b){if(b&&void 0!=b.length&&"string"!=typeof b){for(var c=[],a=-1,d=b.length>>>0;++a!==d;c[a]=b[a]);return c}return b?[b]:[]},U=MetaphorJs.ns.add,N,Sa,Ha;(function(){var b=[],c=[],a=!1,d=!1,e=function(a,b){return a.priority<b.priority?-1:a.priority>b.priority?1:0};MetaphorJs.registerAttributeHandler=N=function(d,c,e){ea("attr."+d,!0)||(b.push({priority:c,name:d,handler:U("attr."+d,e)}),a=!1)};MetaphorJs.getAttributeHandlers=
Sa=function(){a||(b.sort(e),a=!0);return b};MetaphorJs.registerTagHandler=Ha=function(a,b,e){ea("tag."+a,!0)||(c.push({priority:b,name:a,handler:U("tag."+a,e)}),d=!1)};MetaphorJs.getTagHandlers=function(){d||(c.sort(e),d=!0);return c}})();var Q=MetaphorJs.select=function(){var b=/^[\w[:#.][\w\]*^|=!]*$/,c=/=([^\]]+)/,a=/ *, */,d=/(\([^)]*)\+/,e=/(\[[^\]]+)~/,g=/(~|>|\+)/,f=/ +/,l=/([^[:.#]+)?(?:#([^[:.#]+))?(?:\.([^[:.]+))?(?:\[([^!&^*|$[:=]+)([!$^*|&]?=)?([^:\]]+)?\])?(?::([^(]+)(?:\(([^)]+)\))?)?/,
...
r=0;y=C.exec(x);A=y[1];T=y[2]||"";for(t=y[3];y=s[r++];)n[T]&&(n[T](y,A,t)||"class"===A&&n[T](y,"className",t))&&(D[m++]=y);D=m?D:[];break;default:D=Z((D=F.getElementsByTagName(x)).length?D:[])}else{for(var Ra=x.split(a),Ta=Ra.length-1,hb=!!Ta,Ua,v,K,E,G,B,H,fa,N,J,L,M;m=Ra[Ta--];){v=(Ua=m.replace(d,"$1%").replace(e,"$1&").replace(g," $1 ").split(f)).length;r=0;E=" ";for(s=[F];K=Ua[r++];)if(" "!==K&&">"!==K&&"~"!==K&&"+"!==K&&s){K=K.match(l);G=K[1]||"*";B=K[2];H=K[3]?" "+K[3]+" ":"";A=K[4];T=K[5]||
...
null!==a.parentNode.getAttribute("mjs-recursive"),l=c(g,a[Ia],null,f.length,w))l.subscribe(this.onTextChange,this),f.push({node:a,tr:l}),this.renderText(f.length-1)}else if(1==e){b||(b=Sa());var k=a.attributes;l=[];var p=[],u,x,A,e="tag."+a.tagName.toLowerCase();if(u=ea(e,!0)){A=this.runHandler(u,g,a);if(!1===A)return!1;ca(A)?l.push(A):d(p,A)}u=0;for(x=b.length;u<x;u++)if(w=b[u].name,null!==(A=a.getAttribute(w))){A=this.runHandler(b[u].handler,g,a,A);a.removeAttribute(w);if(!1===A)return!1;ca(A)?
...
destroy:function(){delete this.node;delete this.scope;this.watcher&&(this.watcher.unsubscribeAndDestroy(this.onChange,this),delete this.watcher)}});var Ka=function(b){var c=b.nodeName.toLowerCase();b=b.type;return"input"!=c&&"textarea"!=c&&"select"!=c||"submit"==b||"reset"==b||"button"==b?!1:!0},kb=Array.prototype.indexOf,Xa=MetaphorJs.inArray=function(b,c){return c?-1!=kb.call(c,b):!1},ma=MetaphorJs.getValue=function(){var b=/\r/,c={option:function(a){var b=a.getAttribute("value");return null!=b?
b:O(a.innerText||a.textContent)},select:function(a){for(var b,c=a.options,g=a.selectedIndex,f=(a="select-one"===a.type||0>g)?null:[],l=a?g+1:c.length,h,q=0>g?l:a?g:0;q<l;q++)if(b=c[q],h=b.disabled||null!==b.getAttribute("disabled")||b.parentNode.disabled,(b.selected||q===g)&&!h){b=ma(b);if(a)return b;f.push(b)}return f},radio:function(a){return null===a.getAttribute("value")?"on":a.value},checkbox:function(a){return null===a.getAttribute("value")?"on":a.value}};return function(a){var d,e;if((d=c[a.type]||
c[a.nodeName.toLowerCase()])&&void 0!==(e=d(a,"value")))return e;e=a.value;return"string"===typeof e?e.replace(b,""):null==e?"":e}}(),La=MetaphorJs.setValue=function(){var b={select:function(b,a){for(var d,e,g=b.options,f=Z(a),l=g.length,h=-1;l--;)e=g[l],(e.selected=Xa(e.value,f))?d=!0:null!==e.getAttribute("mjs-default-option")&&(h=l);d||(b.selectedIndex=h);return f}};b.radio=b.checkbox=function(b,a){if(G(a))return b.checked=Xa(ma(b),a)};return function(c,a){if(1===c.nodeType){null===a?a="":"number"===
typeof a&&(a+="");var d=b[c.type]||b[c.nodeName.toLowerCase()];d&&void 0!==d(c,a,"value")||(c.value=a)}}}();N("mjs-bind",1E3,L(null,"MetaphorJs.view.AttributeHandler",{isInput:!1,recursive:!1,textRenderer:null,initialize:function(b,c,a){this.isInput=Ka(c);(this.recursive=null!==c.getAttribute("mjs-recursive"))?(this.scope=b,this.node=c,this.textRenderer=new Va(b,"{{"+a+"}}",null,null,!0),this.textRenderer.subscribe(this.onTextRendererChange,this),this.onTextRendererChange(),b instanceof W&&b.$on("destroy",
this.onScopeDestroy,this)):this.supr(b,c,a)},onTextRendererChange:function(){this.updateElement(this.textRenderer.getString())},onChange:function(){var b=this.watcher.getLastResult();this.updateElement(b)},updateElement:function(b){this.isInput?La(this.node,b):this.node[Ia]=b},destroy:function(){this.textRenderer&&(this.textRenderer.destroy(),delete this.textRenderer);this.supr()}}));N("mjs-bind-html",1E3,L(null,"attr.mjs-bind",{updateElement:function(b){this.node.innerHTML=b}}));(function(){var b=
function(b,a,d,e){if(null!==d){if(d==qa(b,a))return;d=!d}else d=qa(b,a);d?e?Y(b,[a+"-remove"],null,!0).done(function(){R(b,a)}):R(b,a):e?Y(b,[a+"-add"],null,!0).done(function(){M(b,a)}):M(b,a)};N("mjs-class",1E3,L(null,"MetaphorJs.view.AttributeHandler",{initial:!0,onChange:function(){var c=this.node,a=this.watcher.getLastResult(),d;xa(c);if("string"==typeof a)b(c,a,null,!this.initial);else if(G(a)){var e;d=-1;for(e=a.length;++d<e;b(c,a[d],!0,!this.initial));}else for(d in a)b(c,d,a[d]?!0:!1,!this.initial);
this.initial=!1}}))})();N("mjs-cmp-prop",200,["$parentCmp","$node","$attrValue",function(b,c,a){b&&(b[a]=c)}]);(function(){var b=function(b,a,d,e){var g,f,l,h,q;a.removeAttribute("mjs-cmp");d=d.split(" ");l=0;for(h=d.length;l<h;l++)q=d[l],""!=q&&"as"!=q&&(g?f=q:g=q);ra(g,{scope:b,node:a,as:f,parentRenderer:e,destroyScope:!0},b,a);return!1};b.$breakScope=!0;N("mjs-cmp",200,b)})();var Ya=wa.createGetter;N("mjs-each",100,L(null,"MetaphorJs.view.AttributeHandler",{model:null,itemName:null,tpl:null,renderers:null,
parentEl:null,prevEl:null,nextEl:null,initialize:function(b,c,a){this.parseExpr(a);c.removeAttribute("mjs-each");c.removeAttribute("mjs-include");this.tpl=c;this.renderers=[];this.prevEl=c.previousSibling;this.nextEl=c.nextSibling;this.parentEl=c.parentNode;this.node=c;this.scope=b;try{this.watcher=ka(b,this.model,this.onChange,this)}catch(d){la(d)}this.parentEl.removeChild(c);this.render(Z(this.watcher.getValue()))},onScopeDestroy:function(){var b=this.renderers,c,a;c=0;for(a=b.length;c<a;c++)b[c].renderer.destroy();
delete this.renderers;delete this.tpl;delete this.prevEl;delete this.nextEl;delete this.parentEl;this.supr()},doUpdate:function(b,c){for(var a=this.renderers,d=c,e=a.length,g=e-1,f=!(d%2),l,h;d<e;d++)l=a[d],h=l.scope,h.$index=d,h.$first=0===d,h.$last=d===g,h.$even=f,h.$odd=!f,f=!f,l.renderer?h.$check():(l.renderer=new Ja(l.el,l.scope),l.renderer.process())},render:function(b){var c=this.renderers,a=this.tpl,d=this.parentEl,e=this.nextEl,g=document.createDocumentFragment(),f,l,h;l=0;for(h=b.length;l<
h;l++)f=a.cloneNode(!0),g.appendChild(f),c.push(this.createItem(f,b,l));d.insertBefore(g,e);this.doUpdate(b,0)},createItem:function(b,c,a){var d=this.itemName,e=this.scope.$new();e[d]=c[a];return{el:b,scope:e}},onChange:function(b){var c=this,a=c.renderers;b=b.prescription||[];var d=c.tpl,e=0,g=c.parentEl,f=Z(c.watcher.getValue()),l=null,h,q,r,z;q=0;for(r=b.length;q<r;q++)z=b[q],"-"==z?(a[e].scope.$index=e,e++):(null===l&&(l=0<q?q-1:0),"I"!=z&&a[e]&&(h=a[e],h.scope.$destroy(),Y(h.el,"leave",null,
!0).done(function(a){sa(a)&&a.parentNode.removeChild(a)})),"D"==z?a.splice(e,1):(h=d.cloneNode(!0),Y(h,"enter",function(b){return function(d){0<b?g.insertBefore(d,a[b-1].el.nextSibling):c.prevEl?g.insertBefore(d,c.prevEl.nextSibling):g.insertBefore(d,g.firstChild)}}(e),!0),"R"==z?a[e]=c.createItem(h,f,e):"I"==z&&(q<a.length?a.splice(e,0,c.createItem(h,f,e)):a.push(c.createItem(h,f,e))),e++));c.doUpdate(f,l)},parseExpr:function(b){b=b.split(" ");var c,a,d,e,g;c=0;for(a=b.length;c<a;c++)if(g=b[c],""!=
g&&"in"!=g)if(e){d=b.slice(c).join(" ");break}else e=g;this.model=d;this.itemName=e||"item"}},{$stopRenderer:!0}));N("mjs-each-in-store",100,L(null,"attr.mjs-each",{store:null,initialize:function(b,c,a){this.parseExpr(a);c.removeAttribute("mjs-each-in-store");c.removeAttribute("mjs-include");this.tpl=c;this.renderers=[];this.prevEl=c.previousSibling;this.nextEl=c.nextSibling;this.parentEl=c.parentNode;this.node=c;this.scope=b;this.store=b=Ya(this.model)(b);this.parentEl.removeChild(c);this.initWatcher();
this.render(this.watcher.getValue());this.bindStore(b,"on")},onScopeDestroy:function(){this.bindStore(this.store,"un");delete this.store;this.supr()},initWatcher:function(){this.watcher=ka(this.store,".items",null);this.watcher.subscribe(this.onChange,this)},resetWatcher:function(){this.watcher.setValue(this.store.items)},bindStore:function(b,c){b[c]("load",this.onStoreUpdate,this);b[c]("update",this.onStoreUpdate,this);b[c]("add",this.onStoreUpdate,this);b[c]("remove",this.onStoreUpdate,this);b[c]("replace",
this.onStoreUpdate,this);b[c]("filter",this.onStoreFilter,this);b[c]("clearfilter",this.onStoreFilter,this);b[c]("clear",this.onStoreClear,this);b[c]("destroy",this.onStoreDestroy,this)},onStoreUpdate:function(){this.watcher.check()},onStoreFilter:function(){this.resetWatcher();this.onStoreUpdate()},onStoreClear:function(){this.resetWatcher();this.onStoreUpdate()},onStoreDestroy:function(){this.onStoreClear();this.watcher.unsubscribeAndDestroy(this.onChange,this);delete this.watcher}},{$stopRenderer:!0}));
var Ma=wa.createFunc,ya=MetaphorJs.returnTrue=function(){return!0};(function(){var b=function(c){if(c instanceof b)return c;if(!(this instanceof b))return new b(c);for(var a in c)if(!this[a])try{this[a]=c[a]}catch(d){}this.originalEvent=c;this.type=c.type;!this.target&&c.srcElement&&(this.target=c.srcElement);var e,g=c.button;"undefined"==typeof this.pageX&&null!=c.clientX&&(e=this.target?this.target.ownerDocument||document:document,a=e.documentElement,e=e.body,this.pageX=c.clientX+(a&&a.scrollLeft||
e&&e.scrollLeft||0)-(a&&a.clientLeft||e&&e.clientLeft||0),this.pageY=c.clientY+(a&&a.scrollTop||e&&e.scrollTop||0)-(a&&a.clientTop||e&&e.clientTop||0));this.which||void 0===g||(this.which=g&1?1:g&2?3:g&4?2:0);this.isDefaultPrevented=c.defaultPrevented||void 0===c.defaultPrevented&&!1===c.returnValue?ya:pa;this.timeStamp=c&&c.timeStamp||(new Date).getTime()};b.prototype={isDefaultPrevented:pa,isPropagationStopped:pa,isImmediatePropagationStopped:pa,preventDefault:function(){var b=this.originalEvent;
this.isDefaultPrevented=ya;b.returnValue=!1;b&&b.preventDefault&&b.preventDefault()},stopPropagation:function(){var b=this.originalEvent;this.isPropagationStopped=ya;b&&b.stopPropagation&&b.stopPropagation()},stopImmediatePropagation:function(){var b=this.originalEvent;this.isImmediatePropagationStopped=ya;b&&b.stopImmediatePropagation&&b.stopImmediatePropagation();this.stopPropagation()}};MetaphorJs.lib.NormalizedEvent=b})();var X=MetaphorJs.normalizeEvent=function(){var b=MetaphorJs.lib.NormalizedEvent;
return function(c){return new b(c)}}();(function(){var b="click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste enter".split(" "),c,a;c=0;for(a=b.length;c<a;c++)(function(a){var b=a;"enter"==b&&(b="keyup");N("mjs-"+a,1E3,function(c,f,l){var h=Ma(l);E(f,b,function(b){b=b||window.event;b=X(b);if("enter"==a&&13!=b.keyCode)return null;c.$event=b;try{h(c)}catch(e){la(e)}delete c.$event;c instanceof W?c.$root.$check():
c.$$watchers&&c.$$watchers.$checkAll();b.preventDefault();return!1})})})(b[c])})();N("mjs-show",500,L(null,"MetaphorJs.view.AttributeHandler",{initial:!0,initialize:function(b,c,a){this.supr(b,c,a)},runAnimation:function(b){var c=this.node.style,a=function(){c.display=b?"":"none"};this.initial?a():Y(this.node,b?"show":"hide",function(){b&&(c.display="")},!0).done(a)},onChange:function(){var b=this.watcher.getLastResult();this.runAnimation(b);this.initial=!1}}));N("mjs-hide",500,L(null,"attr.mjs-show",
{onChange:function(){var b=this.watcher.getLastResult();this.runAnimation(!b);this.initial=!1}}));N("mjs-if",500,L(null,"MetaphorJs.view.AttributeHandler",{parentEl:null,prevEl:null,el:null,initial:!0,initialize:function(b,c,a){this.parentEl=c.parentNode;this.prevEl=c.previousSibling;this.supr(b,c,a)},onScopeDestroy:function(){delete this.prevEl;delete this.parentEl;this.supr()},onChange:function(){var b=this,c=b.watcher.getLastResult(),a=b.parentEl,d=b.node,e=function(){b.prevEl?a.insertBefore(d,
b.prevEl?b.prevEl.nextSibling:null):a.appendChild(d)},g=function(){a.removeChild(d)};c?sa(d)||(b.initial?e():Y(d,"enter",e,!0)):sa(d)&&(b.initial?g():Y(d,"leave",null,!0).done(g));b.initial=!1}}));N("mjs-ignore",0,pa);N("mjs-include",900,function(b,c,a,d){b=new oa({scope:b,node:c,url:a,parentRenderer:d});return b.ownRenderer?!1:b.initPromise});N("mjs-init",250,function(b,c,a){c.removeAttribute("mjs-init");Ma(a)(b)});var aa=MetaphorJs.removeListener=function(b,c,a){b.detachEvent?b.detachEvent("on"+
c,a):b.removeEventListener(c,a,!1)},lb=MetaphorJs.isSubmittable=function(b){var c=b.type?b.type.toLowerCase():"";return"input"==b.nodeName.toLowerCase()&&"radio"!=c&&"checkbox"!=c},Na=navigator.userAgent.toLowerCase(),mb=function(){var b=parseInt((/android (\d+)/.exec(Na)||[])[1],10)||!1;return function(){return b}}(),Za=function(){var b=parseInt((/msie (\d+)/.exec(Na)||[])[1],10);isNaN(b)&&(b=parseInt((/trident\/.*; rv:(\d+)/.exec(Na)||[])[1],10)||!1);return function(){return b}}(),$a=function(){var b=
{};return function(c){if(void 0===b[c]){if("input"==c&&9==Za())return b[c]=!1;var a=document.createElement("div");b[c]=!!("on"+c in a)}return b[c]}}();(function(){var b=function(b,a,d,e){this.el=b;this.cb=a;this.scb=e;this.cbContext=d;this.inputType=a=b.getAttribute("mjs-input-type")||b.type.toLowerCase();this.listeners=[];this.submittable=lb(b);"radio"==a?this.initRadioInput():"checkbox"==a?this.initCheckboxInput():this.initTextInput()};b.prototype={el:null,inputType:null,cb:null,scb:null,cbContext:null,
listeners:[],radio:null,submittable:!1,destroy:function(){var b=this.inputType,a=this.listeners,d=this.radio,e=this.el,g,f,l,h;g=0;for(f=a.length;g<f;g++)if("radio"==b)for(l=0,h=d.length;l<h;l++)aa(d[l],a[g][0],a[g][1]);else aa(e,a[g][0],a[g][1]);delete this.radio;delete this.el;delete this.cb;delete this.cbContext},initRadioInput:function(){var b=this.el,a=b.type,b=b.name,d,e,g;this.onRadioInputChangeDelegate=v(this.onRadioInputChange,this);if(document.querySelectorAll)d=document.querySelectorAll("input[name="+
b+"]");else{var f=document.getElementsByTagName("input"),l;d=[];e=0;for(g=f.length;e<g;e++)l=f[e],l.type==a&&l.name==b&&d.push(l)}this.radio=d;this.listeners.push(["click",this.onRadioInputChangeDelegate]);e=0;for(g=d.length;e<g;e++)E(d[e],"click",this.onRadioInputChangeDelegate)},initCheckboxInput:function(){this.onCheckboxInputChangeDelegate=v(this.onCheckboxInputChange,this);this.listeners.push(["click",this.onCheckboxInputChangeDelegate]);E(this.el,"click",this.onCheckboxInputChangeDelegate)},
initTextInput:function(){var b=!1,a=this,d=a.el,e=a.listeners,g;if(!mb()){var f=function(){b=!0},l=function(){b=!1;h()};e.push(["compositionstart",f]);e.push(["compositionend",l]);E(d,"compositionstart",f);E(d,"compositionend",l)}var h=a.onTextInputChangeDelegate=function(){if(!b)a.onTextInputChange()};if($a("input"))e.push(["input",h]),E(d,"input",h);else{var q=function(a){g||(g=window.setTimeout(function(){h(a);g=null},0))},f=function(b){b=b||window.event;var d=b.keyCode;if(13==d&&a.submittable&&
a.scb)return a.scb.call(a.cbContext,b);91===d||15<d&&19>d||37<=d&&40>=d||q(b)};e.push(["keydown",f]);E(d,"keydown",f);$a("paste")&&(e.push(["paste",q]),e.push(["cut",q]),E(d,"paste",q),E(d,"cut",q))}e.push(["change",h]);E(d,"change",h)},processValue:function(b){switch(this.inputType){case "number":b=parseInt(b,10)}return b},onTextInputChange:function(){var b=this.getValue();this.cb.call(this.cbContext,b)},onCheckboxInputChange:function(){var b=this.el;this.cb.call(this.cbContext,b.checked?b.getAttribute("value")||
!0:!1)},onRadioInputChange:function(b){b=b||window.event;this.cb.call(this.cbContext,(b.target||b.srcElement).value)},setValue:function(b){var a=this.inputType,d,e;if("radio"==a)for(a=this.radio,d=0,e=a.length;d<e;d++){if(a[d].value==b){a[d].checked=!0;break}}else"checkbox"==a?(a=this.el,a.checked=!0===b||b==a.value):La(this.el,b)},getValue:function(){var b=this.inputType,a,d;if("radio"==b){b=this.radio;a=0;for(d=b.length;a<d;a++)if(b[a].checked)return b[a].value;return null}return"checkbox"==b?this.el.checked?
this.el.getAttribute("value")||!0:!1:this.processValue(ma(this.el))}};MetaphorJs.lib.Input=b})();var ab=MetaphorJs.lib.Input;N("mjs-model",1E3,L(null,"MetaphorJs.view.AttributeHandler",{inProg:!1,input:null,binding:null,initialize:function(b,c,a){this.node=c;this.input=new ab(c,this.onInputChange,this);this.binding=c.getAttribute("mjs-data-binding")||"both";var d=this.input.getValue();this.supr(b,c,a);b=this.watcher.getLastResult();if("scope"!=this.binding&&this.watcher&&(d||b&&this.watcher.hasInputPipes()))this.onInputChange(b||
d)},onInputChange:function(b){var c=this.scope;"scope"!=this.binding&&(b&&"string"==typeof b&&-1!=b.indexOf("\\{")&&(b=b.replace(/\\{/g,"{")),this.watcher.setValue(b),this.inProg=!0,c instanceof W?c.$root.$check():this.watcher.checkAll(),this.inProg=!1)},destroy:function(){this.input.destroy();delete this.input;this.supr()},onChange:function(){var b=this.watcher.getLastResult();"input"==this.binding||this.inProg||this.input.setValue(b)}}));N("mjs-options",100,L(null,"MetaphorJs.view.AttributeHandler",
{model:null,getterFn:null,defOption:null,prevGroup:null,groupEl:null,fragment:null,initialize:function(b,c,a){this.parseExpr(a);c.removeAttribute("mjs-options");this.node=c;this.scope=b;for(this.defOption=c.options.length?c.options[0]:null;c.firstChild;)c.removeChild(c.firstChild);this.defOption&&this.defOption.setAttribute("mjs-default-option","");try{this.watcher=ka(b,this.model,this.onChange,this)}catch(d){la(d)}this.render(Z(this.watcher.getValue()))},onChange:function(){this.render(Z(this.watcher.getValue()))},
renderOption:function(b,c,a){var d=this.groupEl||this.fragment,e=Za();a.item=b;a.$index=c;b=this.getterFn(a);void 0!=b.group&&(b.group=""+b.group);b.group!==this.prevGroup&&(b.group?(this.groupEl=d=document.createElement("optgroup"),d.setAttribute("label",b.group),b.disabledGroup&&d.setAttribute("disabled","disabled"),this.fragment.appendChild(d)):(d=this.fragment,this.groupEl=null));this.prevGroup=b.group;c=document.createElement("option");c.setAttribute("value",b.value);c.text=b.name;e&&9>e&&(c.innerHTML=
b.name);b.disabled&&c.setAttribute("disabled","disabled");d.appendChild(c)},render:function(b){var c=this.node,a=ma(c),d=this.defOption,e=this.scope.$new(),g,f;this.fragment=document.createDocumentFragment();for(this.groupEl=this.prevGroup=null;c.firstChild;)c.removeChild(c.firstChild);g=0;for(f=b.length;g<f;g++)this.renderOption(b[g],g,e);d&&c.insertBefore(d,c.firstChild);e.$destroy();c.appendChild(this.fragment);this.fragment=null;La(c,a)},parseExpr:function(b){var c=b.indexOf(" in "),a;-1==c?(a=
b,b="{name: .item, value: .$index}"):(a=b.substr(c+4),b=b.substr(0,c));this.model=a;this.getterFn=Ya(b)}}));(function(){var b="selected checked disabled readonly required open".split(" "),c,a;c=0;for(a=b.length;c<a;c++)(function(a){N("mjs-"+a,1E3,L(null,"MetaphorJs.view.AttributeHandler",{onChange:function(){this.watcher.getLastResult()?this.node.setAttribute(a,!0):this.node.removeAttribute(a)}}))})(b[c])})();var nb=MetaphorJs.parentData=function(b,c){for(var a;b;){a=H(b,c);if(void 0!=a)return a;
b=b.parentNode}},bb=function(b){var c=nb(b,"mjs-transclude");if(c){b.firstChild&&H(b,"mjs-transclude",ja(b.childNodes));var a=b.parentNode,d=b.nextSibling,c=va(c),e=Z(c.childNodes);a.removeChild(b);a.insertBefore(c,d);return e}return null};N("mjs-transclude",1E3,function(b,c){return bb(c)});N("mjs-view",200,function(b,c,a){c.removeAttribute("mjs-view");ra(a||"MetaphorJs.cmp.View",{scope:b,node:c},b,c);return!1});Ha("mjs-include",900,function(b,c,a,d){return(new oa({scope:b,node:c,tpl:c.getAttribute("src"),
parentRenderer:d,replace:!0})).initPromise});Ha("mjs-transclude",900,function(b,c){return bb(c)});(function(){var b=function(a,b,c){if(""===b||"undefined"==typeof b)return!0;if("undefined"!=typeof a){if("boolean"==typeof a)return a===b;if(c instanceof RegExp)return b.test(""+a);if("strict"==c)return""+a===""+b;if(!0===c||null===c||"undefined"==typeof c)return-1!=""+a.indexOf(b);if(!1===c)return-1==""+a.indexOf(b)}return!1},c=function(a,d,c){if("object"!=typeof a)return"undefined"==typeof d.$?!0:b(a,
d.$,c);var g,f;for(g in d)if("$"==g)for(f in a){if(b(a[f],d.$,c))return!0}else if(b(a[g],d[g],c))return!0;return!1};U("filter.filter",function(a,b,e,g){b=e;"object"!=typeof b&&(b={$:b});e=[];var f,l;f=-1;for(l=a.length;++f<l;)c(a[f],b,g)&&e.push(a[f]);return e})})();U("filter.fromList",function(b,c,a){a=a||", ";return b&&b.length?(G(b)||(b=Z(b)),b.join(a)):""});U("filter.limitTo",function(b,c,a){c=typeof b;if(!G(b)&&"string"!=c)return b;a=Infinity===Math.abs(Number(a))?Number(a):parseInt(a,10);if("string"==
c)return a?0<=a?b.slice(0,a):b.slice(a,b.length):"";c=[];var d;a>b.length?a=b.length:a<-b.length&&(a=-b.length);0<a?d=0:(d=b.length+a,a=b.length);for(;d<a;d++)c.push(b[d]);return c});U("filter.linkify",function(b,c,a){return b?b.replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig,'<a href="$1"'+(a?' target="'+a+'"':"")+">$1</a>"):""});U("filter.lowercase",function(b){return b.toLowerCase()});MetaphorJs.dateFormats={};U("filter.moment",function(b,c,a){a=cb[a]||a;return moment(b).format(a)});
var cb=MetaphorJs.numberFormats={};U("filter.numeral",function(b,c,a){a=cb[a]||a;return numeral(b).format(a)});U("filter.sortBy",function(b,c,a,d){d||(d="asc");b=b.slice();b.sort(function(b,d){var c=typeof b,l=b,h=d;if(c!=typeof d)return 0;"object"==c&&(l=b[a],h=d[a]);if("number"==typeof l)return l-h;l=(""+l).toLowerCase();h=(""+h).toLowerCase();return l===h?0:l>h?1:-1});return"desc"==d?b.reverse():b});U("filter.toArray",function(b){return Z(b)});U("filter.toList",function(b,c,a,d){d=d||void 0;a=
a||"/\\n|,/";if(!b)return[];b=""+b;"/"==a.substr(0,1)&&"/"==a.substr(a.length-1)&&(a=Ba(a.substring(1,a.length-1)));b=b.split(a,d);c=-1;for(a=b.length;++c<a;b[c]=O(b[c]));return b});U("filter.ucfirst",function(b){return b.substr(0,1).toUpperCase()+b.substr(1)});U("filter.uppercase",function(b){return b.toUpperCase()});var ob=MetaphorJs.initApp=function(b,c,a){b.removeAttribute("mjs-app");try{return ra(c||"MetaphorJs.cmp.App",!1,a,b,[b,a])}catch(d){return la(d),P.reject(d)}};(MetaphorJs.onReady=function(b){var c=
!1,a=!0,d=window,e=d.document,g=e.documentElement,f=function(a){if("readystatechange"!=a.type||"complete"==e.readyState)aa("load"==a.type?d:e,a.type,f),!c&&(c=!0)&&b.call(d,a.type||a)},l=function(){try{g.doScroll("left")}catch(a){setTimeout(l,50);return}f("poll")};if("complete"==e.readyState)b.call(d,"lazy");else{if(e.createEventObject&&g.doScroll){try{a=!d.frameElement}catch(h){}a&&l()}E(e,"DOMContentLoaded",f);E(e,"readystatechange",f);E(d,"load",f)}})(function(){var b=Q("[mjs-app]"),c,a,d,e=function(a){a.run()};
c=-1;for(a=b.length;++c<a;)d=b[c],ob(d,d.getAttribute&&d.getAttribute("mjs-app")).done(e)});var db=function(b,c){var a,d;if(!b||"string"!==typeof b)return null;try{d=new DOMParser,a=d.parseFromString(b,c||"text/xml")}catch(e){a=void 0}if(!a||a.getElementsByTagName("parsererror").length)throw"Invalid XML: "+b;return a};(function(){var b=/#.*$/,c=/([?&])_=[^&]*/,a=/\?/,d=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,e=/^(?:GET|HEAD)$/i,g=0,f=function(a,b,d){var c,e;if("string"==typeof a&&
d)b.push(encodeURIComponent(d)+"="+encodeURIComponent(a));else if(G(a)&&d)for(c=0,e=a.length;c<e;c++)f(a[c],b,d+"["+c+"]");else if("object"==typeof a)for(c in a)a.hasOwnProperty(c)&&f(a[c],b,d?d+"["+c+"]":c)},l=function(d,k){d.replace(b,"");if(!1===k.cache){var g=(new Date).getTime();return c.test(d)?d.replace(c,"$1_="+g):d+(a.test(d)?"&":"?")+"_="+g}!k.data||window.FormData&&k.data instanceof window.FormData||("string"!=typeof k.data?(g=[],f(k.data,g,null),g=g.join("&").replace(/%20/g,"+")):g=k.data,
k.data=g,e.test(k.method)&&(d+=(a.test(d)?"&":"?")+k.data,k.data=null));return d},h={xml:"application/xml, text/xml",html:"text/html",script:"text/javascript, application/javascript",json:"application/json, text/javascript",text:"text/plain",_default:"*/*"},q={url:null,data:null,method:"GET",headers:null,username:null,password:null,cache:null,dataType:null,timeout:0,contentType:"application/x-www-form-urlencoded",xhrFields:null,jsonp:!1,jsonpParam:null,jsonpCallback:null,transport:null,replace:!1,
selector:null,form:null,beforeSend:null,progress:null,uploadProgress:null,processResponse:null,callbackScope:null},I={},z=new da,C=function(a){var b;b=eval;a&&(/^[^\S]*use strict/.test(a)?(b=document.createElement("script"),b.text=a,document.head.appendChild(b).parentNode.removeChild(b)):b(a))},w=function(a,b,d){var c,e;if("object"!=typeof a&&"function"!=typeof a&&d)c=document.createElement("input"),c.setAttribute("type","hidden"),c.setAttribute("name",d),c.setAttribute("value",a),b.appendChild(c);
else if(G(a)&&d)for(c=0,e=a.length;c<e;c++)w(a[c],b,d+"["+c+"]");else if("object"==typeof a)for(c in a)a.hasOwnProperty(c)&&w(a[c],b,d?d+"["+c+"]":c)},k=function(a){for(var b,d,c="",e=0;e<a.elements.length;e++)if(b=a.elements[e],b.hasAttribute("name"))if(d="INPUT"===b.nodeName.toUpperCase()?b.getAttribute("type").toUpperCase():"TEXT","FILE"===d)for(d=0;d<b.files.length;c+="&"+encodeURIComponent(b.name)+"="+encodeURIComponent(b.files[d++].name));else if("RADIO"!==d&&"CHECKBOX"!==d||b.checked)c+="&"+
encodeURIComponent(b.name)+"="+encodeURIComponent(b.value);return c},p=function(a,b,d){var c=b?b.dataType:null;b=b?b.selector:null;if("string"!=typeof a)return a;d=d||"";if("xml"===c||!c&&0<=d.indexOf("xml"))return a=db(O(a)),b?Q(b,a):a;if("html"===c)return a=db(a,"text/html"),b?Q(b,a):a;if("fragment"==c){d=document.createDocumentFragment();c=document.createElement("div");for(c.innerHTML=a;c.firstChild;)d.appendChild(c.firstChild);return d}if("json"===c||!c&&0<=d.indexOf("json"))return a=O(a),a="undefined"!=
typeof JSON?JSON.parse(a):(new Function("return "+a))(),a;("script"===c||!c&&0<=d.indexOf("javascript"))&&C(a);return a+""},u=function(a){var b=d.exec(("undefined"!=typeof window?window.location.href:"").toLowerCase())||[],c=d.exec(a.url.toLowerCase());this._opt=a;a.crossDomain=!(!c||c[1]===b[1]&&c[2]===b[2]&&(c[3]||("http:"===c[1]?"80":"443"))===(b[3]||("http:"===b[1]?"80":"443")));b=new P;"iframe"!=a.transport||a.form?a.form&&(this._form=a.form,"POST"!=a.method||"undefined"!=typeof window&&window.FormData||
"iframe"==a.transport||(a.transport="iframe")):(this.createForm(),a.form=this._form);a.form&&"iframe"!=a.transport&&(a.data="POST"==a.method?new FormData(a.form):k(a.form));a.url=l(a.url,a);c=!a.crossDomain&&"script"!=a.transport||a.form?"iframe"==a.transport?new V(a,b,this):new A(a,b,this):new n(a,b,this);this._deferred=b;this._transport=c;b.done(function(a){z.trigger("success",a)});b.fail(function(a){z.trigger("error",a)});b.always(function(){z.trigger("end")});z.trigger("start");a.timeout&&(this._timeout=
setTimeout(v(this.onTimeout,this),a.timeout));a.jsonp&&this.createJsonp();!1===z.trigger("beforeSend",a,c)&&(this._promise=P.reject());a.beforeSend&&!1===a.beforeSend.call(a.callbackScope,a,c)&&(this._promise=P.reject());this._promise||(Qa(c.send,c),b.abort=v(this.abort,this),b.always(this.destroy,this),this._promise=b)};u.prototype={_jsonpName:null,_transport:null,_opt:null,_deferred:null,_promise:null,_timeout:null,_form:null,_removeForm:!1,promise:function(){return this._promise},abort:function(a){this._transport.abort();
this._deferred.reject(a||"abort")},onTimeout:function(){this.abort("timeout")},createForm:function(){var a=document.createElement("form");a.style.display="none";a.setAttribute("method",this._opt.method);w(this._opt.data,a,null);document.body.appendChild(a);this._form=a;this._removeForm=!0},createJsonp:function(){var b=this._opt,d=b.jsonpParam||"callback",c=b.jsonpCallback||"jsonp_"+ ++g;b.url+=(a.test(b.url)?"&":"?")+d+"="+c;this._jsonpName=c;"undefined"!=typeof window&&(window[c]=v(this.jsonpCallback,
...
d.reject("jsonp script didn't invoke callback")}else d.reject("jsonp script is empty");else try{d.resolve(this.processResponseData(a,b))}catch(e){d.reject(e)}},destroy:function(){this._timeout&&clearTimeout(this._timeout);this._form&&this._form.parentNode&&this._removeForm&&this._form.parentNode.removeChild(this._form);this._transport.destroy();delete this._transport;delete this._opt;delete this._deferred;delete this._promise;delete this._timeout;delete this._form;this._jsonpName&&("undefined"!=typeof window&&
delete window[this._jsonpName],"undefined"!=typeof global&&delete global[this._jsonpName])}};var x=function(a,b){b=b||{};a&&"string"!=typeof a?b=a:b.url=a;if(!b.url&&(b.form&&(b.url=b.form.getAttribute("action")),!b.url))throw"Must provide url";r(b,I,!1,!0);r(b,q,!1,!0);b.method=b.method?b.method.toUpperCase():b.form?b.form.getAttribute("method").toUpperCase()||"GET":"GET";return(new u(b)).promise()};x.setup=function(a){r(I,a,!0,!0)};x.on=function(){z.on.apply(z,arguments)};x.un=function(){z.un.apply(z,
arguments)};x.get=function(a,b){b=b||{};b.method="GET";return x(a,b)};x.post=function(a,b){b=b||{};b.method="POST";return x(a,b)};x.load=function(a,b,d){d=d||{};"string"!=typeof b&&(d=b);d.dataType="fragment";return x(b,d).done(function(b){if(d.replace)for(;a.firstChild;)a.removeChild(a.firstChild);a.appendChild(b)})};x.loadScript=function(a){return x(a,{transport:"script"})};x.submit=function(a,b){b=b||{};b.form=a;return x(null,b)};var A=function(a,b,d){var c;if(!(window.XMLHttpRequest&&(c=new XMLHttpRequest)||
(c=new ActiveXObject("Msxml2.XMLHTTP"))||(c=new ActiveXObject("Microsoft.XMLHTTP"))))throw"Unable to create XHR object";this._xhr=c;this._deferred=b;this._opt=a;this._ajax=d;a.progress&&E(c,"progress",v(a.progress,a.callbackScope));a.uploadProgress&&c.upload&&E(c.upload,"progress",v(a.uploadProgress,a.callbackScope));try{var e;if(a.xhrFields)for(e in a.xhrFields)c[e]=a.xhrFields[e];a.data&&a.contentType&&c.setRequestHeader("Content-Type",a.contentType);c.setRequestHeader("X-Requested-With","XMLHttpRequest");
c.setRequestHeader("Accept",a.dataType&&h[a.dataType]?h[a.dataType]+", */*; q=0.01":h._default);for(e in a.headers)c.setRequestHeader(e,a.headers[e])}catch(k){}c.onreadystatechange=v(this.onReadyStateChange,this)};A.prototype={_xhr:null,_deferred:null,_ajax:null,onReadyStateChange:function(){var a=this._xhr,b=this._deferred;if(0===a.readyState)a.onreadystatechange=B,b.resolve(a);else if(4===a.readyState){a.onreadystatechange=B;var d;a:{try{d=!a.status&&"undefined"!=typeof location&&"file:"==location.protocol||
200<=a.status&&300>a.status||304===a.status||1223===a.status;break a}catch(c){}d=!1}d?this._ajax.processResponse("string"==typeof a.responseText?a.responseText:void 0,a.getResponseHeader("content-type")||""):b.reject(a)}},abort:function(){this._xhr.onreadystatechange=B;this._xhr.abort()},send:function(){var a=this._opt;try{this._xhr.open(a.method,a.url,!0,a.username,a.password),this._xhr.send(a.data)}catch(b){this._deferred.reject(b)}},destroy:function(){delete this._xhr;delete this._deferred;delete this._opt;
delete this._ajax}};var n=function(a,b,d){this._opt=a;this._ajax=d;this._deferred=b};n.prototype={_opt:null,_deferred:null,_ajax:null,_el:null,send:function(){var a=document.createElement("script");a.setAttribute("async","async");a.setAttribute("charset","utf-8");a.setAttribute("src",this._opt.url);E(a,"load",v(this.onLoad,this));E(a,"error",v(this.onError,this));document.head.appendChild(a);this._el=a},onLoad:function(a){this._deferred&&this._deferred.resolve(a)},onError:function(a){this._deferred.reject(a)},
abort:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el)},destroy:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el);delete this._el;delete this._opt;delete this._ajax;delete this._deferred}};var V=function(a,b,d){this._opt=a;this._ajax=d;this._deferred=b};V.prototype={_opt:null,_deferred:null,_ajax:null,_el:null,send:function(){var a=document.createElement("iframe"),b="frame-"+ ++g,d=this._opt.form;a.setAttribute("id",b);a.setAttribute("name",b);a.style.display=
"none";document.body.appendChild(a);d.setAttribute("action",this._opt.url);d.setAttribute("target",b);E(a,"load",v(this.onLoad,this));E(a,"error",v(this.onError,this));this._el=a;try{d.submit()}catch(c){this._deferred.reject(c)}},onLoad:function(){var a=this._el;this._opt&&!this._opt.jsonp&&(a=a.contentDocument||a.contentWindow.document,a=a.body.innerHTML,this._ajax.processResponse(a))},onError:function(a){this._deferred.reject(a)},abort:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el)},
destroy:function(){this._el.parentNode&&this._el.parentNode.removeChild(this._el);delete this._el;delete this._opt;delete this._ajax;delete this._deferred}};MetaphorJs.ajax=x})();var na=MetaphorJs.ajax,ga=MetaphorJs.factory;(function(){var b={},c={};L("MetaphorJs.data.Model",{type:null,fields:null,record:null,store:null,plain:!1,initialize:function(a){this.fields={};r(this,{record:{load:null,save:null,"delete":null,id:null,data:null,success:null,extra:{}},store:{load:null,save:null,"delete":null,
id:null,data:null,total:null,start:null,limit:null,success:null,extra:{}}},!1,!0);r(this,a,!0,!0);this.plain=!this.type},isPlain:function(){return this.plain},getRecordProp:function(a,b){return this.getProp("record",a,b)},setRecordProp:function(a,b){this.record[a]=b},getStoreProp:function(a,b){return this.getProp("store",a,b)},setStoreProp:function(a,b){this.store[a]=b},getProp:function(a,b,c){a=this[a];return a[b]&&a[b][c]||a[c]||this[c]||null},setProp:function(a,b){return this[a]=b},_createAjaxCfg:function(a,
b,c,g){var f=this,l=f[a],h=r({},"string"==typeof l[b]?{url:l[b]}:l[b]),q=f.getProp(a,b,"id"),v=f.getProp(a,b,"data"),z=f.getProp(a,b,"url"),C=f.getProp(a,b,"json");if(!h)if(z)h={url:z};else throw a+"."+b+" not defined";"string"==typeof h&&(h={url:h});if(!h.url){if(!z)throw a+"."+b+" url not defined";h.url=z}h.data=r({},h.data,f.extra,l.extra,l[b]?l[b].extra:{},!1,!0);h.method||(h.method="load"==b?"GET":"POST");c&&(h.data[q]=c);g&&(v?h.data[v]=g:h.data=g);C&&h.data&&"GET"!=h.method&&(h.data=JSON.stringify(h.data));
h.callbackScope=f;"record"==a?h.processResponse=function(a,c){f._processRecordResponse(b,a,c)}:"store"==a&&(h.processResponse=function(a,c){f._processStoreResponse(b,a,c)});return h},_processRecordResponse:function(a,b,c){var g=this.getRecordProp(a,"id"),f=this.getRecordProp(a,"data"),g=(f=f?b[f]:b)&&f[g]||b[g];this._getSuccess("record",a,b)?c.resolve({id:g,data:f}):c.reject(b)},_processStoreResponse:function(a,b,c){var g=this.getStoreProp(a,"data"),f=this.getStoreProp(a,"total"),g=g?b[g]:b,f=f?b[f]:
null;this._getSuccess("store",a,b)?c.resolve({data:g,total:f}):c.reject(b)},_getSuccess:function(a,b,c){return(a=this.getProp(a,b,"success"))&&void 0!=c[a]?c[a]:!0},loadRecord:function(a){return na(this._createAjaxCfg("record","load",a))},saveRecord:function(a,b,c){return na(this._createAjaxCfg("record",a.getId()?"save":"create",a.getId(),r({},a.storeData(a.getData(b)),c)))},deleteRecord:function(a){return na(this._createAjaxCfg("record","delete",a.getId()))},loadStore:function(a,b){return na(r(this._createAjaxCfg("store",
"load"),b,!0,!0))},saveStore:function(a,b){return na(this._createAjaxCfg("store","save",null,b))},deleteRecords:function(a,b){return na(this._createAjaxCfg("store","delete",b))},getFields:function(){return this.fields},restoreField:function(a,b,c){var g=this.fields[b];if(g){switch("string"==typeof g?g:g.type){case "int":c=parseInt(c);break;case "bool":case "boolean":"string"==typeof c?(c=c.toLowerCase(),c=!("off"===c||"no"===c||"0"===c||"false"==c||"null"==c)):c=c?!0:!1;break;case "double":case "float":c=
parseFloat(c);break;case "date":g.parseFn?c=g.parseFn(c,g.format):Date.parse?c=Date.parse(c,g.format):("timestamp"==g.format&&(c=1E3*parseInt(c)),c=new Date(c))}g.restore&&(c=g.restore.call(a,c,b))}return this.onRestoreField(a,b,c)},onRestoreField:function(a,b,c){return c},storeField:function(a,b,c){var g=this.fields[b];if(g){switch("string"==typeof g?g:g.type){case "bool":case "boolean":c=c?"1":"0";break;case "date":c=g.formatFn?g.formatFn(c,g.format):Date.format?Date.format(c,g.format):"timestamp"==
g.format?c.getTime()/1E3:c.format?c.format(g.format):c.toString();break;default:c=c.toString()}g.store&&(c=g.store.call(a,c,b))}return this.onStoreField(a,b,c)},onStoreField:function(a,b,c){return c}},{create:function(a,c){return"MetaphorJs.data.Model"==a?ga(a,c):c?ga(a,c):b[a]?b[a]:b[a]=ga(a)},addToCache:function(a){var b=a.getClass(),e=a.getId();"MetaphorJs.data.Record"!=b&&(c[b]||(c[b]={}),c[b][e]=a)},getFromCache:function(a,b){return c[a]&&c[a][b]?c[a][b]:null},removeFromCache:function(a,b){c[a]&&
c[a][b]&&delete c[a][b]}})})();var eb=MetaphorJs.isInstanceOf,za=MetaphorJs.data.Model;L("MetaphorJs.data.Record","MetaphorJs.cmp.Base",{id:null,data:null,orig:null,modified:null,loaded:!1,dirty:!1,destroyed:!1,model:null,standalone:!0,stores:null,initialize:function(b,c,a){var d=arguments.length;1==d?(a=b,c=b=null):2==d&&(a=c,c=null);this.data={};this.orig={};this.stores=[];this.modified={};a=a||{};this.supr(a);"string"==typeof this.model?this.model=ga(this.model):eb(this.model,"MetaphorJs.data.Model")||
(this.model=ga("MetaphorJs.data.Model",this.model));this.id=b;c?this.importData(c):!1!==a.autoLoad&&b&&this.load();"MetaphorJs.data.Record"!=this.getClass()&&za.addToCache(this)},isLoaded:function(){return this.loaded},isStandalone:function(){return this.standalone},isDirty:function(){return this.dirty},getModel:function(){return this.model},attachStore:function(b){b=b.getId();-1==this.stores.indexOf(b)&&this.stores.push(b)},detachStore:function(b){b=b.getId();var c;this.destroyed||-1==(c=this.stores.indexOf(b))||
(this.stores.splice(c,1),0!=this.stores.length||this.standalone||this.destroy())},setDirty:function(b){this.dirty!=b&&(this.dirty=!!b,this.trigger("dirtychange",this,b))},importData:function(b){var c={},a;if(b){for(a in b)c[a]=this.model.restoreField(this,a,b[a]);this.data=c}this.orig=r({},this.data);this.modified={};this.loaded=!0;this.setDirty(!1)},storeData:function(b){var c={},a;for(a in b)c[a]=this.model.storeField(this,a,b[a]);return c},getId:function(){return this.id},getData:function(b){if(b){var c=
{},a,d;b="string"==typeof b?[b]:b;a=0;for(d=b.length;a<d;a++)c[b[a]]=this.data[b[a]];return c}return r({},this.data)},getChanged:function(){return r({},this.modified)},isChanged:function(b){return this.modified[b]||!1},get:function(b){return this.data[b]},setId:function(b){!this.id&&b&&(this.id=b)},set:function(b,c){var a=this.data[b];c=this.model.restoreField(this,b,c);this.data[b]=c;a!=c&&(this.modified[b]=!0,this.setDirty(!0),this.trigger("change",this,b,c,a),this.trigger("change-"+b,this,b,c,
a))},revert:function(){this.dirty&&(this.data=r({},this.orig),this.modified={},this.setDirty(!1))},load:function(){var b=this;b.trigger("beforeload",b);return b.model.loadRecord(b.id).done(function(c){b.setId(c.id);b.importData(c.data);b.trigger("load",b)}).fail(function(){b.trigger("failedload",b)})},save:function(b,c){var a=this;a.trigger("beforesave",a);return a.model.saveRecord(a,b,c).done(function(b){a.setId(b.id);a.importData(b.data);a.trigger("save",a)}).fail(function(b){a.trigger("failedsave",
a)})},"delete":function(){var b=this;b.trigger("beforedelete",b);return b.model.deleteRecord(b).done(function(){b.trigger("delete",b);b.destroy()}).fail(function(){b.trigger("faileddelete",b)})},reset:function(){this.id=null;this.data={};this.orig={};this.modified={};this.dirty=this.loaded=!1;this.trigger("reset",this)},destroy:function(){this.destroyed||(this.destroyed=!0,this.trigger("destroy",this),this.stores=this.model=this.modified=this.orig=this.data=null,za.removeFromCache(this.getClass(),
this.id),this.supr())}});var ha=MetaphorJs.data.Record;(function(){var b=0,c={};L("MetaphorJs.data.Store","MetaphorJs.cmp.Base",{id:null,autoLoad:!1,clearOnLoad:!0,model:null,extraParams:null,loaded:!1,loading:!1,local:!1,items:null,map:null,keys:null,length:0,totalLength:0,start:0,pageSize:null,pages:null,filtered:!1,filterBackup:null,filterFn:null,filterScope:null,filterParams:null,initialize:function(a,d,e){this.items=[];this.map={};this.keys=[];this.loaded=!1;this.extraParams=this.extraParams||
{};a&&"string"!=typeof a&&(e=d,d=a,a=null);d=d||{};this.supr(d);this.id=this.id||++b;c[this.id]=this;"string"==typeof this.model?this.model=ga(this.model):eb(this.model,za)||(this.model=ga("MetaphorJs.data.Model",this.model));if(a||d.url)this.model.store.load=a||d.url;!this.local&&this.autoLoad?this.load():e&&(G(e)?this.loadArray(e):this.loadAjaxData(e));this.local&&(this.loaded=!0)},getId:function(){return this.id},isLoaded:function(){return this.loaded},isLocal:function(){return this.local},setLocal:function(a){this.local=
!!a},isLoading:function(){return this.loading},isFiltered:function(){return this.filtered},getLength:function(){return this.length},getTotalLength:function(){return this.filtered?this.length:this.totalLength||this.length},getPagesCount:function(){return null!==this.pageSize?parseInt(this.totalLength/this.pageSize):1},setParam:function(a,b){this.extraParams[a]=b},getParam:function(a){return this.extraParams[a]},setStart:function(a){this.start=a},setPageSize:function(a){this.pageSize=a},getAjaxData:function(){return this.ajaxData},
hasDirty:function(){if(this.model.isPlain())return!1;var a=!1;this.each(function(b){return b.isDirty()?(a=!0,!1):!0});return a},getDirty:function(){var a=[];if(this.model.isPlain())return a;this.each(function(b){b.isDirty()&&a.push(b)});return a},getModel:function(){return this.model},importData:function(a){this.suspendAllEvents();for(var b=0;b<a.length;b++)this.add(a[b]);this.resumeAllEvents();this.loaded=!0;this.loading=!1;this.onLoad();this.trigger("load",this)},load:function(a){var b=this,c=b.model.store,
g=c.start,c=c.limit;if(b.local)return null;a=r({},b.extraParams,a||{});null===b.pageSize||a[g]||a[c]||(a[g]=b.start,a[c]=b.pageSize);return!1===b.trigger("beforeload",b)?null:b.model.loadStore(b,a).done(function(a){b.totalLength=parseInt(a.total);b.importData(a.data);b.totalLength=parseInt(a.total)}).fail(function(a){b.onFailedLoad();b.trigger("failedload",b,a)})},onLoad:B,onFailedLoad:B,save:function(){var a=this,b={},c=0;if(a.local)return null;if(a.model.isPlain())throw Error("Cannot save plain store");
a.each(function(a){a.isDirty()&&(b[a.getId()]=a.storeData(a.getData()),c++)});if(!c)throw Error("Nothing to save");return!1===a.trigger("beforesave",a,b)?null:a.model.saveStore(a,b).done(function(b){var c,d,e=b.data;if(e&&e.length)for(b=0,c=e.length;b<c;b++)d=a.getRecordId(e[b]),(d=a.getById(d))&&d.importData(e[b]);a.onSave();a.trigger("save",a)}).fail(function(){a.onFailedSave();a.trigger("failedsave",a)})},onSave:B,onFailedSave:B,deleteById:function(a){var b=this,c,g,f;if(b.local)return null;if(!a||
G(a)&&!a.length)throw Error("Record id required");G(a)||(a=[a]);c=0;for(g=a.length;c<g;c++)f=b.getById(a[c]),f instanceof ha?f.destroy():b.removeId(a[c]);return!1===b.trigger("beforedelete",b,a)?null:b.model.deleteRecords(b,a).done(function(){b.onDelete();b.trigger("delete",b,a)}).fail(function(){b.onFailedDelete();b.trigger("faileddelete",b,a)})},onDelete:B,onFailedDelete:B,deleteAt:function(a){var b=this.getAt(a);if(!b)throw Error("Record not found at "+a);return this.deleteRecord(b)},"delete":function(a){return this.deleteById(this.getRecordId(a))},
...
0,A=q.length;x<A;x++)for(v=-1,w=r.length;++v<w;d(r[v],q[x],h[e]));else for(u in q)for(v=-1,w=r.length;++v<w;k(r[v],q[u],u,h[e]));}}else t.bindSelfOnRender=!0}}},resetDynamicTarget:function(){var a=t.dynamicTargetEl;a&&(n.setHandlers("unbind","_target"),n.trigger("targetchange",h,null,a))},isDynamicTargetChanged:function(a){var b=m.target;a=a.target;for(var c=t.dynamicTargetEl;a&&!Oa(a,b);)a=a.parentNode;return a?!c||c!==a:!1},changeDynamicTarget:function(a){var b=m.target;a=a.target;for(var c=t.dynamicTargetEl;a&&
!Oa(a,b);)a=a.parentNode;if(!a||c&&c===a)return!1;c&&n.setHandlers("unbind","_target");t.dynamicTargetEl=a;n.setHandlers("bind","_target");n.trigger("targetchange",h,a,c);return!0},showAfterDelay:function(a,b){t.showDelay=null;if(t.visible){m.position.manual||n.reposition(a);"mouse"==t.position&&E(document.documentElement,"mousemove",n.onMouseMove);var c=m.position;(c.resize||c.screenX||c.screenY)&&E(window,"resize",n.onWindowResize);(c.scroll||c.screenX||c.screenY)&&E(window,"scroll",n.onWindowScroll);
...
n.animate("hide",null,!0).done(function(){y.style.display="none"}):y.style.display="none");m.hide.animate&&!b?n.animate("hide").done(function(){n.hideAfterAnimation(a)}):n.hideAfterAnimation(a)}else t.visible=m.cls.hidden?!qa(s,m.cls.hidden):fb(s),m.debug&&console.log("hideAfterDelay: afterhdelay returned false",n.getTarget())}},hideAfterAnimation:function(a){t.visible?m.debug&&console.log("hideAfterAnimation: already shown again",n.getTarget()):(R(s,m.cls.visible),M(s,m.cls.hidden),m.render.keepVisible||
...
c))},changeDynamicContent:function(){m.content.fn?n.setContent(m.content.fn.call(z,h)):m.content.attr&&n.readContent()},getDialogSize:function(){var b=m.cls.hidden?qa(s,m.cls.hidden):!fb(s),d,k=s.style.left;b&&(c(s,{left:"-1000px"}),s.style.display="");d={width:a(s).width,height:a(s).height};b&&(c(s,{left:k}),s.style.display="none");return d},getTargetSize:function(){var b=n.getTarget();return b?{width:a(b).width,height:a(b).height}:null},getTargetPosition:function(b,c){var d=n.getTarget();if(!d)return null;
