...
components:null,initialize:function(a,b){var c=b instanceof x?b:new x(b),d,e;c.$app=this;this.supr();d=new ua;e=new E;this.lang=new Ja;v(this,d.getApi(),!0,!1);this.destroyProvider=w(d.destroy,d);v(this,e.getApi(),!0,!1);this.destroyObservable=w(e.destroy,e);this.scope=c;this.cmpListeners={};this.components={};this.factory("$parentCmp",["$node",this.getParentCmp],this);this.value("$app",this);this.value("$rootScope",c.$root);this.value("$lang",this.lang);this.renderer=new ja(a,c);d=Y.call(arguments);
...
b.scope;d=d||b.node;b.scope=b.scope||c;b.node=b.node||d;var f=y(a)?N(a):a;if(!f)throw"Component "+a+" not found";c&&f.$isolateScope&&(b.scope=c=c.$newIsolated());var h,k=[];a=f.template||b.template||null;var m=f.templateUrl||b.templateUrl||null,l=c?c.$app:null,p=ua.global(),n=l?l.inject:p.inject,q=l?l:p,r=d?d.getAttribute("mjs-cloak"):null,t={$node:d||null,$scope:c||null,$config:b||null,$args:e||null};if(f.resolve)for(h in f.resolve)(function(a){var g=new u,m;k.push(g.done(function(c){t[a]=c;b[a]=
...
13!=b.keyCode)return null;c.$event=b;try{k(c)}catch(e){G(e)}delete c.$event;c instanceof x?c.$root.$check():c.$$watchers&&c.$$watchers.$checkAll();b.preventDefault();return!1})})})(a[b])})();l("mjs-show",500,n(null,D,{initial:!0,initialize:function(a,b,c){this.supr(a,b,c)},runAnimation:function(a){var b=this.node.style,c=function(){b.display=a?"":"none"};this.initial?c():t(this.node,a?"show":"hide",function(){a&&(b.display="")},!0).done(c)},onChange:function(){var a=this.watcher.getLastResult();this.runAnimation(a);
this.initial=!1}}));l("mjs-hide",500,n(null,"attr.mjs-show",{onChange:function(){var a=this.watcher.getLastResult();this.runAnimation(!a);this.initial=!1}}));l("mjs-if",500,n(null,D,{parentEl:null,prevEl:null,el:null,initial:!0,initialize:function(a,b,c){this.parentEl=b.parentNode;this.prevEl=b.previousSibling;this.supr(a,b,c)},onScopeDestroy:function(){delete this.prevEl;delete this.parentEl;this.supr()},onChange:function(){var a=this,b=a.watcher.getLastResult(),c=a.parentEl,d=a.node,e=function(){a.prevEl?
c.insertBefore(d,a.prevEl?a.prevEl.nextSibling:null):c.appendChild(d)},g=function(){c.removeChild(d)};b?U(d)||(a.initial?e():t(d,"enter",e,!0)):U(d)&&(a.initial?g():t(d,"leave",null,!0).done(g));a.initial=!1}}));l("mjs-ignore",0,Q);l("mjs-include",900,function(a,b,c,d){a=new O({scope:a,node:b,url:c,parentRenderer:d});return a.ownRenderer?!1:a.initPromise});l("mjs-init",250,function(a,b,c){b.removeAttribute("mjs-init");oa(c)(a)});l("mjs-model",1E3,n(null,D,{inProg:!1,input:null,binding:null,initialize:function(a,
b,c){this.node=b;this.input=new fa(b,this.onInputChange,this);this.binding=b.getAttribute("mjs-data-binding")||"both";var d=this.input.getValue();this.supr(a,b,c);a=this.watcher.getLastResult();if("scope"!=this.binding&&this.watcher&&(d||a&&this.watcher.hasInputPipes()))this.onInputChange(a||d)},onInputChange:function(a){var b=this.scope;"scope"!=this.binding&&(a&&y(a)&&-1!=a.indexOf("\\{")&&(a=a.replace(/\\{/g,"{")),this.watcher.setValue(a),this.inProg=!0,b instanceof x?b.$root.$check():this.watcher.checkAll(),
this.inProg=!1)},destroy:function(){this.input.destroy();delete this.input;this.supr()},onChange:function(){var a=this.watcher.getLastResult();"input"==this.binding||this.inProg||this.input.setValue(a)}}));var xa=navigator.userAgent.toLowerCase(),Ka=function(){var a=parseInt((/msie (\d+)/.exec(xa)||[])[1],10);isNaN(a)&&(a=parseInt((/trident\/.*; rv:(\d+)/.exec(xa)||[])[1],10)||!1);return function(){return a}}(),ya=R.createGetter;l("mjs-options",100,n(null,D,{model:null,getterFn:null,defOption:null,
prevGroup:null,groupEl:null,fragment:null,initialize:function(a,b,c){this.parseExpr(c);b.removeAttribute("mjs-options");this.node=b;this.scope=a;for(this.defOption=b.options.length?b.options[0]:null;b.firstChild;)b.removeChild(b.firstChild);this.defOption&&this.defOption.setAttribute("mjs-default-option","");try{this.watcher=I(a,this.model,this.onChange,this,null,B)}catch(d){G(d)}this.render(C(this.watcher.getValue()))},onChange:function(){this.render(C(this.watcher.getValue()))},renderOption:function(a,
b,c){var d=this.groupEl||this.fragment,e=Ka();c.item=a;c.$index=b;a=this.getterFn(c);void 0!=a.group&&(a.group=""+a.group);a.group!==this.prevGroup&&(a.group?(this.groupEl=d=document.createElement("optgroup"),d.setAttribute("label",a.group),a.disabledGroup&&d.setAttribute("disabled","disabled"),this.fragment.appendChild(d)):(d=this.fragment,this.groupEl=null));this.prevGroup=a.group;b=document.createElement("option");b.setAttribute("value",a.value);b.text=a.name;e&&9>e&&(b.innerHTML=a.name);a.disabled&&
b.setAttribute("disabled","disabled");d.appendChild(b)},render:function(a){var b=this.node,c=Fa(b),d=this.defOption,e=this.scope.$new(),g,f;this.fragment=document.createDocumentFragment();for(this.groupEl=this.prevGroup=null;b.firstChild;)b.removeChild(b.firstChild);g=0;for(f=a.length;g<f;g++)this.renderOption(a[g],g,e);d&&b.insertBefore(d,b.firstChild);e.$destroy();b.appendChild(this.fragment);this.fragment=null;sa(b,c)},parseExpr:function(a){var b=a.indexOf(" in "),c;-1==b?(c=a,a="{name: .item, value: .$index}"):
(c=a.substr(b+4),a=a.substr(0,b));this.model=c;this.getterFn=ya(a)}}));(function(){var a="selected checked disabled readonly required open".split(" "),b,c;b=0;for(c=a.length;b<c;b++)(function(a){l("mjs-"+a,1E3,n(null,D,{onChange:function(){this.watcher.getLastResult()?this.node.setAttribute(a,!0):this.node.removeAttribute(a)}}))})(a[b])})();var za=function(a){var b;a:{for(var c=a,d;c;){d=J(c,"mjs-transclude");if(void 0!=d){b=d;break a}c=c.parentNode}b=void 0}if(b){a.firstChild&&J(a,"mjs-transclude",
K(a.childNodes));c=a.parentNode;d=a.nextSibling;b=ca(b);var e=C(b.childNodes);c.removeChild(a);c.insertBefore(b,d);return e}return null};l("mjs-transclude",1E3,function(a,b){return za(b)});l("mjs-view",200,function(a,b,c){b.removeAttribute("mjs-view");P(c||"MetaphorJs.cmp.View",{scope:a,node:b},a,b);return!1});A=ia.registerTagHandler;A("mjs-include",900,function(a,b,c,d){return(new O({scope:a,node:b,tpl:b.getAttribute("src"),parentRenderer:d,replace:!0})).initPromise});A("mjs-transclude",900,function(a,
b){return za(b)});(function(){var a=function(a,b,e){if(""===b||r(b))return!0;if(!r(a)){if(aa(a))return a===b;if(e instanceof RegExp)return b.test(""+a);if("strict"==e)return""+a===""+b;if(!0===e||null===e||r(e))return-1!=""+a.indexOf(b);if(!1===e)return-1==""+a.indexOf(b)}return!1},b=function(b,d,e){if(M(b)){var g,f;for(g in d)if("$"==g)for(f in b){if(a(b[f],d.$,e))return!0}else if(a(b[g],d[g],e))return!0}else return r(d.$)?!0:a(b,d.$,e);return!1};q("filter.filter",function(a,d,e,g){d=e;M(d)||(d=
{$:d});e=[];var f,h;f=-1;for(h=a.length;++f<h;)b(a[f],d,g)&&e.push(a[f]);return e})})();q("filter.fromList",function(a,b,c){c=c||", ";return a&&a.length?(F(a)||(a=C(a)),a.join(c)):""});q("filter.l",function(a,b){return b.$app.lang.get(a)});q("filter.limitTo",function(a,b,c){b=y(a);if(!F(a)&&!b)return a;c=Infinity===Math.abs(Number(c))?Number(c):parseInt(c,10);if(b)return c?0<=c?a.slice(0,c):a.slice(c,a.length):"";b=[];var d;c>a.length?c=a.length:c<-a.length&&(c=-a.length);0<c?d=0:(d=a.length+c,c=
...
c.$pristine=!1;this.scope.$check()},onFieldStateChange:function(a,b,c){var d=this.scopeState,e=b.getName();a=a.isDisplayStateEnabled();b={$error:b.getErrorRule(),$errorMessage:b.getError(),$invalid:!1===c,$pristine:null===b.getExactValidState()};a?d[e]=b:d[e].$real=b;this.scope.$check()}});l("mjs-validate",250,function(a,b,c){c=c||"MetaphorJs.view.Validator";var d=N(c);d?new d(b,a):G(Error("Class '"+c+"' not found"))});p.onReady=Aa;p.initApp=Ba;p.ns=B;p.cs=X;p.resolveComponent=P;p.animate=t;p.stopAnimation=
la;p.ajax=pa;p.select=ra;p.bind=w;p.extend=v;p.trim=H;p.pushUrl=qa;p.currentUrl=va;p.history=L;p.run=function(){Aa(function(){var a=ra("[mjs-app]"),b,c,d,e=function(a){a.run()};b=-1;for(c=a.length;++b<c;)d=a[b],Ba(d,d.getAttribute&&d.getAttribute("mjs-app")).done(e)})};p.lib.Promise=u;p.lib.Observable=E;return p});
