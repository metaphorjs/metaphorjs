'use strict';define("metaphorjs","metaphorjs-observable metaphorjs-promise metaphorjs-ajax metaphorjs-animate metaphorjs-input metaphorjs-class metaphorjs-namespace metaphorjs-select metaphorjs-validator metaphorjs-watchable metaphorjs-dialog metaphorjs-history".split(" "),function(ha,w,zb,A,qa,Ab,Bb,ra,Cb,Fa,Db,sa){function H(){}function x(e,a){return e.getAttribute?e.getAttribute(a):null}function S(e){return"object"==typeof e&&3===Q(e)&&!e.nodeType&&e.constructor===Object}function ia(e){return!0===
e||!1===e}function B(e){return"object"==typeof e&&5===Q(e)}function M(e){if(e&&void 0!=!e.length&&e!==""+e){for(var a=[],b=-1,c=e.length>>>0;++b!==c;a[b]=e[b]);return a}return e?[e]:[]}function F(e){return"function"==typeof e}function T(e){if(!e||!e.then)return!1;var a,b;return"object"!=(b=typeof e)&&"function"!=b?!1:F(a=e.then)?a:!1}function C(e){return"string"==typeof e||e===""+e}function Za(e){var a={},b,c,d=e.attributes;e=0;for(b=d.length;e<b;e++)c=d[e],a[c.name]=c.value;return a}function Ga(e){if(null===
e||"object"!=typeof e)return!1;e=Q(e);return 2<e||-1==e}function N(e){var a=document.createDocumentFragment();if(C(e)){var b=document.createElement("div");b.innerHTML=e;e=b.childNodes}if(e.nodeType)a.appendChild(e);else for(var b=-1,c=e.length>>>0;++b!==c;a.appendChild(e[0]));return a}function Ha(e){return Ia("(?:^|\\s)"+e+"(?!\\S)")}function U(e,a){a&&(e.className=e.className.replace(Ha(a),""))}function ta(e,a,b,c){setTimeout(function(){e.apply(a,b||[])},c||0)}function ua(e){return 1===Q(e)}function K(e){var a=
e.stack||Error().stack;if("undefined"!=typeof console&&console.log)ta(function(){console.log(e);a&&console.log(a)});else throw e;}function va(e){e=Q(e);return 3>e&&-1<e}function $a(e){return e.replace(Eb,function(a){return a.charAt(1).toUpperCase()})}function D(e,a,b){var c=G(e,"config"),d;if(c)return c;c={};if(b||null!==(b=x(e,"mjs-config")))for(d in e.removeAttribute("mjs-config"),a=b?wa(b)(a||{}):{},a)c[d]=a[d];a=ab(e);for(d in a)b=a[d],c[d]=""===b?!0:b;G(e,"config",c);return c}function xa(e,a){return a?
Ha(a).test(e.className):!1}function ya(e,a){a&&!xa(e,a)&&(e.className+=" "+a)}function da(e,a,b,c,d){var g=!1!==a;a=a||{};d=d||[];b=b||a.scope;c=c||a.node;a.scope=a.scope||b;a.node=a.node||c;var h=C(e)?V(e):e;if(!h)throw"Component "+e+" not found";b&&h.$isolateScope&&(a.scope=b=b.$newIsolated());var k,l=[];e=h.template||a.template||null;var m=h.templateUrl||a.templateUrl||null,f=b?b.$app:null,bb=Ja.global(),s=f?f.inject:bb.inject,z=f?f:bb,n=c?x(c,"mjs-cloak"):null,v={$node:c||null,$scope:b||null,
$config:a||null,$args:d||null};if(h.resolve)for(k in h.resolve)(function(g){var e=new w,m;l.push(e.done(function(b){v[g]=b;a[g]=b;d.push(b)}));m=h.resolve[k];F(m)?e.resolve(m(b,c)):C(m)?e.resolve(s.resolve(m)):e.resolve(s.call(z,m,null,u({},v,a,!1,!1)))})(k);g&&(e||m)&&(a.template=new W({scope:b,node:c,deferRendering:!0,ownRenderer:!0,shadow:h.$shadow,tpl:e,url:m}),l.push(a.template.initPromise),c&&c.firstChild&&G(c,"mjs-transclude",N(c.childNodes)));g&&d.unshift(a);var r;l.length?(r=new w,w.all(l).done(function(){r.resolve(s.call(z,
h,null,u({},v,a,!1,!1),d))})):r=w.resolve(s.call(z,h,null,u({},v,a,!1,!1),d));c&&r.isPending()&&null!==n&&(n?ya(c,n):c.style.visibility="hidden",r.then(function(){n?U(c,n):c.style.visibility=""}));c&&r.then(function(){U(c,"mjs-cloak")});return r}function X(){return!1}function Ka(e){var a=e.nodeName.toLowerCase();e=e.type;return"input"!=a&&"textarea"!=a&&"select"!=a||"submit"==e||"reset"==e||"button"==e?!1:!0}function ja(){return!0}function La(e){return new ea(e)}function Y(e,a,b){e.attachEvent?e.attachEvent("on"+
a,b):e.addEventListener(a,b,!1)}function cb(e,a){for(var b;e;){b=G(e,a);if(void 0!==b)return b;e=e.parentNode}}function Ma(e){var a=cb(e,"mjs-transclude");if(a){e.firstChild&&G(e,"mjs-transclude",N(e.childNodes));var b=e.parentNode,c=e.nextSibling,a=za(a),d=M(a.childNodes);b.removeChild(e);b.insertBefore(a,c);return d}return null}function db(e,a,b){b||(b="asc");e=e.slice();e.sort(function(b,d){var g=typeof b,e=b,k=d;if(g!=typeof d)return 0;"object"==g&&(F(a)?(e=a(b),k=a(d)):(e=b[a],k=d[a]));if("number"==
typeof e)return e-k;e=(""+e).toLowerCase();k=(""+k).toLowerCase();return e===k?0:e>k?1:-1});return"desc"==b?e.reverse():e}function Aa(e){return 10===Q(e)}function Ba(e){return 9===Q(e)}function Na(e){return e===window||e&&e.document&&e.location&&e.alert&&e.setInterval}function Oa(e,a,b){var c,d=e.childNodes;if(!1!==a.call(b,e))for(e=-1,c=d.length>>>0;++e!==c;Oa(d[e],a,b));}function ka(e){var a={top:0,left:0};if(!fa(e)||e===window)return a;e.getBoundingClientRect&&(a=e.getBoundingClientRect());return{top:a.top+
eb()-I.clientTop,left:a.left+fb()-I.clientLeft}}function gb(e){for(e=e.offsetParent||I;e&&e!=I&&"static"==O(e,"position");)e=e.offsetParent;return e||I}function Pa(e,a,b){e.detachEvent?e.detachEvent("on"+a,b):e.removeEventListener(a,b,!1)}function hb(e){var a=!1,b=!0,c=window,d=c.document,g=d.documentElement,h=function(b){if("readystatechange"!=b.type||"complete"==d.readyState)Pa("load"==b.type?c:d,b.type,h),!a&&(a=!0)&&e.call(c,b.type||b)},k=function(){try{g.doScroll("left")}catch(a){setTimeout(k,
50);return}h("poll")};if("complete"==d.readyState)e.call(c,"lazy");else{if(d.createEventObject&&g.doScroll){try{b=!c.frameElement}catch(l){}b&&k()}Y(d,"DOMContentLoaded",h);Y(d,"readystatechange",h);Y(c,"load",h)}}function ib(e,a,b,c){try{var d=da(a||"MetaphorJs.App",!1,b,e,[e,b]);return!1!==c?d.done(function(a){a.run()}):d}catch(g){return K(g),w.reject(g)}}var Fb=qa.getValue,Gb=qa.setValue,Qa=ra.is,f={},E=new Bb(f,"MetaphorJs"),jb=new Ab(E),q=jb.define,Z=Array.prototype.slice,Hb=Object.prototype.toString,
Q=function(){var e={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(a){if(!a){if(null===a)return 6;if(void 0===a)return 7}var b=e[Hb.call(a)];return void 0===b?-1:1==b&&isNaN(a)?8:b}}(),u=function(){return function a(){var b=!1,c=!1,d=Z.call(arguments),g=d.shift(),h,k,l;ia(d[d.length-1])&&(b=d.pop());ia(d[d.length-1])&&(c=b,b=d.pop());for(;d.length;)if(h=d.shift())for(k in h)if(h.hasOwnProperty(k)&&
void 0!==(l=h[k]))if(c)if(g[k]&&S(g[k])&&S(l))a(g[k],l,b,c);else{if(!0===b||void 0==g[k])S(l)?(g[k]={},a(g[k],l,b,!0)):g[k]=l}else if(!0===b||void 0==g[k])g[k]=l;return g}}(),J=function(e){this.$$observable=new ha;this.$$historyWatchers={};u(this,e,!0,!1);this.$parent?(this.$parent.$on("check",this.$$onParentCheck,this),this.$parent.$on("destroy",this.$$onParentDestroy,this)):(this.$root=this,this.$isRoot=!0)};u(J.prototype,{$app:null,$parent:null,$root:null,$isRoot:!1,$$observable:null,$$watchers:null,
...
e.length,b;a;){a--;b=e[a].charCodeAt(0);if(57==b)return e[a]="A",e.join("");if(90==b)e[a]="0";else return e[a]=String.fromCharCode(b+1),e.join("")}e.unshift("0");return e.join("")}}(),V=E.get,Ra=function(){var e=document.createTextNode("");return C(e.textContent)?"textContent":"nodeValue"}(),aa=function(){return String.prototype.trim?function(e){return C(e)?e.trim():e}:function(e){return C(e)?e.replace(/^\s\s*/,"").replace(/\s\s*$/,""):e}}(),P=Fa.create,p=E.add,n=function(){var e=[],a=!1,b=function(a,
...
this);this.$super()}},{registerAttribute:function(b,d,g){V("attr."+b,!0)||(e.push({priority:d,name:b,handler:p("attr."+b,g)}),a=!1)},getAttributes:function(){a||(e.sort(b),a=!0);return e},registerTag:function(a,b){V("tag."+a,!0)||p("tag."+a,b)}})}(),ba=Function.prototype.bind?function(e,a){return e.bind(a)}:function(e,a){return function(){return e.apply(a,arguments)}},Sa=function(){var e=/\\{/g,a=new ha,b=function(a,b,e,k,l){return!b||!b.indexOf||-1==b.indexOf("{{")&&-1==b.indexOf("{[")?null:new c(a,
b,e,k,l)},c=q({$class:"TextRenderer",id:null,parent:null,isRoot:null,scope:null,origin:"",processed:null,text:null,watchers:null,children:null,data:null,recursive:!1,dataChangeDelegate:null,changeTmt:null,lang:null,$init:function(a,b,c,e,l){this.id=L();this.origin=b;this.scope=a;this.parent=c;this.isRoot=!c;this.data=e;this.lang=a.$app?a.$app.lang:null;if(!0===l||!1===l)this.recursive=l;this.watchers=[];this.children=[];this.dataChangeDelegate=ba(this.doDataChange,this);this.processed=this.processText(b);
this.render()},subscribe:function(b,c){return a.on(this.id,b,c)},unsubscribe:function(b,c){return a.un(this.id,b,c)},getString:function(){null===this.text&&this.render();var a=this.text;return-1!=a.indexOf("\\{")?a.replace(e,"{"):a},render:function(){var a=this.processed,b,e,k;this.children.length||this.createChildren();k=this.children;b=-1;for(e=k.length;++b<e;a=a.replace("---"+b+"---",k[b]instanceof c?k[b].getString():k[b]));return this.text=a},processText:function(a){for(var b=0,c=a.length,e,l,
m="";b<c;)if(-1!=(e=a.indexOf("{{",b))&&-1!=(l=a.indexOf("}}",e+2))&&"\\"!=a.substr(e-1,1))m+=a.substring(b,e),l!=e+2&&(m+=this.watcherMatch(a.substring(e+2,l))),b=l+2;else{b!==c&&(m+=a.substring(b));break}b=0;a=m;c=a.length;for(m="";b<c;)if(-1!=(e=a.indexOf("{[",b))&&-1!=(l=a.indexOf("]}",e+2))&&"\\"!=a.substr(e-1,1))m+=a.substring(b,e),l!=e+2&&(m+=this.watcherMatch(a.substring(e+2,l),!0)),b=l+2;else{b!==c&&(m+=a.substring(b));break}return m},watcherMatch:function(a,b){var c=this.watchers;if(b){a=
aa(a);var e=a.split("|"),l=aa(e[0]);"."!=l.substr(0,1)&&(e[0]="'"+l+"'");1==e.length&&e.push("l");a=e.join(" | ")}c.push(P(this.scope,a,this.onDataChange,this,null,E));return"---"+(c.length-1)+"---"},onDataChange:function(){this.changeTmt||(this.changeTmt=setTimeout(this.dataChangeDelegate,0))},doDataChange:function(){this.destroyChildren();this.triggerChange();this.changeTmt=null},triggerChange:function(){this.text=null;this.isRoot?a.trigger(this.id,this,this.data):this.parent.triggerChange()},createChildren:function(){var a=
this.watchers,c=this.children,e=this.scope,k=this.recursive,l,m,f;l=-1;for(m=a.length;++l<m;)f=a[l].getLastResult(),c.push(k&&b(e,f,this,null,!0)||f)},destroyChildren:function(){var a=this.children,b,e;b=-1;for(e=a.length;++b<e;)a[b]instanceof c&&a[b].$destroy();this.children=[]},destroyWatchers:function(){var a=this.watchers,b,c;b=-1;for(c=a.length;++b<c;a[b].unsubscribeAndDestroy(this.onDataChange,this));this.watchers=[]},destroy:function(){this.destroyChildren();this.destroyWatchers();a.destroyEvent(this.id);
this.changeTmt&&clearTimeout(this.changeTmt)}},{create:b});return c}(),Ca=Array.prototype.indexOf;Ca||(Ca=Array.prototype.indexOf=function(e,a){var b;if(null==this)throw new TypeError('"this" is null or not defined');var c=Object(this),d=c.length>>>0;if(0===d)return-1;b=+a||0;Infinity===Math.abs(b)&&(b=0);if(b>=d)return-1;for(b=Math.max(0<=b?b:d-Math.abs(b),0);b<d;){if(b in c&&c[b]===e)return b;b++}return-1});var ga=function(){var e=null,a=Sa.create,b=function(a,b,c,d,e,h){var f=[];if(a&&!0!==a){if(a.nodeType){h.countdown+=
...
this.texts[a];var b=a.tr.getString(),c=a.attr;c?("value"==c?a.node.value=b:"class"==c?a.node.className=b:"src"==c&&(a.node.src=b),a.node.setAttribute(c,b)):a.node[Ra]=b},destroy:function(){var a=this.texts,b,c;b=-1;for(c=a.length;++b<c;a[b].tr.$destroy());this.parent&&this.parent.un("destroy",this.$destroy,this);h.trigger("destroy-"+this.id)}})}(),kb=function(){var e=function(a,b){"pt_BR"==b&&(b="xbr");3<b.length&&(b=b.substr(0,-b.lastIndexOf("_")));switch(b){case "bo":case "dz":case "id":case "ja":case "jv":case "ka":case "km":case "kn":case "ko":case "ms":case "th":case "tr":case "vi":case "zh":return 0;
...
b)if(a._running=!0,delete a._map[b.id],a.async||b.async){var c=0;ua(b.async)?c=b.async:ua(a.async)&&(c=a.async);ta(function(){try{a._processResult(b.fn.apply(b.context||a.context,b.args||[]))}catch(c){throw K(c),a._finish(),c;}},null,null,c)}else try{a._processResult(b.fn.apply(b.context||a.context,b.args||[]))}catch(d){throw K(d),a._finish(),d;}},_processResult:function(a){var b=this;b.thenable&&T(a)?a.then(function(){b._finish()},function(){b._finish()}):b._finish();return a},_finish:function(){this._running=
...
setTimeout(a,0);return function(){clearTimeout(b)}}}(),Ua=function(){var a=/(^|[^a-z0-9_$])(\.)([^0-9])/ig,b=Function,c=function(a,b){return function(c){var d=Z.call(arguments),g;d.push(null);d.push(a);if(b){for(g=a.apply(null,d);(void 0===g||"number"==typeof g&&isNaN(g))&&!c.$isRoot;)c=c.$parent,d[0]=c,g=a.apply(null,d);return g}return a.apply(null,d)}},d={},g=0,h={},k=0,f={},m=0,t=function(){1E3<=g&&(d={});1E3<=k&&(h={});1E3<=m&&(f={})};return{createGetter:function(h){try{return d[h]?d[h]:(g++,
d[h]=c(new b("____","$$interceptor","$$itself","".concat("try {","return ",h.replace(a,"$1____.$3"),";} catch (thrownError) { return undefined; }")),!0))}catch(k){return K(k),H}},createSetter:function(d){try{if(!h[d]){k++;var g=d.replace(a,"$1____.$3");return h[d]=c(new b("____","$$$$","$$interceptor","$$itself","".concat("try {",g," = $$$$",";} catch (thrownError) { return undefined; }")))}return h[d]}catch(f){return K(f),H}},createFunc:function(d){try{return f[d]?f[d]:(m++,f[d]=c(new b("____","$$interceptor",
"$$itself","".concat("try {",d.replace(a,"$1____.$3"),";} catch (thrownError) { return undefined; }"))))}catch(g){return K(g),H}},resetCache:t,enableResetCacheInterval:function(){setTimeout(t,1E4)}}}(),wa=Ua.createGetter,Eb=/-./g,ab=function(){return document.documentElement.dataset?function(a){return a.dataset}:function(a){var b;if(void 0!==(b=G(a,"data")))return b;b=a.attributes;var c={},d,g,h;d=0;for(g=b.length;d<g;d++)h=b[d].name,0===h.indexOf("data-")&&(c[$a(h.substr(5))]=b[d].value);b=c;G(a,
"data",b);return b}}(),Va=q({$class:"ListRenderer",id:null,model:null,itemName:null,tpl:null,renderers:null,parentEl:null,prevEl:null,nextEl:null,trackBy:null,trackByWatcher:null,animateMove:!1,animate:!1,trackByFn:null,griDelegate:null,queue:null,buffered:!1,bufferPlugin:null,$constructor:function(a,b,c){a=D(b,a);this.animateMove=!a.buffered&&a.animateMove&&A.cssAnimations;this.animate=!a.buffered&&(null!==x(b,"mjs-animate")||a.animate);this.id=a.id||L();b.removeAttribute("mjs-animate");this.animate&&
...
h=this.buffered,k=document.createDocumentFragment(),f,m,t;m=0;for(t=a.length;m<t;m++)f=c.cloneNode(!0),b.push(this.createItem(f,a,m)),h||(k.appendChild(f),b[m].attached=!0);h?(this.bufferPlugin.getScrollOffset(),this.bufferPlugin.updateScrollBuffer()):(this.doUpdate(),d.insertBefore(k,g));this.trigger("render",this)},doUpdate:function(a,b,c,d){var g=this.renderers;a=a||0;var h=g.length;b=b||h-1;var k=this.watcher.getLastResult(),f=this.getTrackByFunction();for(b>h-1&&(b=h-1);a<=b;a++)c&&g[a].action!=
c||this.renderItem(a,g,k,f,d)},renderItem:function(a,b,c,d,g){c=c||this.watcher.getLastResult();b=b||this.renderers;d=d||this.getTrackByFunction();var h=b[a],k=h.scope;b=b.length-1;var f=!(a%2);g&&h.rendered||(k.$index=a,k.$first=0===a,k.$last=a===b,k.$even=f,k.$odd=!f,k.$trackId=d(c[a]),k.$getRawIndex=this.griDelegate,h.renderer?k.$check():(h.renderer=new ga(h.el,k),h.renderer.process(),h.rendered=!0))},createItem:function(a,b,c){var d=this.itemName,g=this.scope.$new();g[d]=this.getListItem(b,c);
return{index:c,action:"enter",el:a,scope:g,attached:!1,rendered:!1}},onChange:function(a,b){this.queue.prepend(this.applyChanges,this,[b],y.REPLACE)},applyChanges:function(a){var b=this,c=b.renderers,d=b.tpl,g=0,h=M(b.watcher.getLastResult()),f=null,l=b.animateMove,m=b.animate,t=[],n=b.itemName,s=c.slice(),z=!1,q,v,r,u,p,x;a=b.watcher.getMovePrescription(a,b.getTrackByFunction(),h);r=0;for(u=a.length;r<u;r++)q=a[r],ua(q)?(v=q,q=c[v],v!=g&&null===f&&(f=r),q.action="move",q.scope[n]=b.getListItem(h,
r),z=l,t.push(q),c[v]=null,g++):(null===f&&(f=r),p=b.createItem(d.cloneNode(!0),h,r),t.push(p));b.renderers=t;if(m){b.doUpdate(f,null,"enter");z&&(x=b.calculateTranslates(t,s,c));var d=[],y=new w,B=new w,C=new w,D=w.counter(t.length),g=function(){D.countdown();return y};r=0;for(u=c.length;r<u;r++)if(p=c[r])p.scope.$destroy(),la(p.el),d.push(A(p.el,"leave",null,!1,E).done(function(a){a.style.visibility="hidden"}));r=0;for(u=t.length;r<u;r++)p=t[r],la(p.el),"enter"==p.action?d.push(A(p.el,"enter",g,
...
b.removeOldElements(c),b.queue.append(b.bufferPlugin.updateScrollBuffer,b.bufferPlugin,[!0])):(b.applyDomPositions(),b.doUpdate(f||0),b.removeOldElements(c));b.trigger("change",b)},removeOldElements:function(a){var b,c,d,g=this.parentEl;b=0;for(c=a.length;b<c;b++)(d=a[b])&&d.attached&&(d.attached=!1,g.removeChild(d.el))},applyDomPositions:function(a){var b=this.renderers,c=this.parentEl,d=this.prevEl,d=d?d.nextSibling:c.firstChild,g,h,f,l,m;h=0;for(f=b.length;h<f;h++)m=b[h],l=m.el,(g=a&&a[h]?a[h].el.nextSibling:
0<h?b[h-1].el.nextSibling||d:d)&&l.nextSibling!==g?c.insertBefore(l,g):g||c.appendChild(l),m.attached=!0},getListItem:function(a,b){return a[b]},onChangeTrackBy:function(a){this.trackByFn=null;this.trackBy=a},getTrackByFunction:function(){var a;this.trackByFn||((a=this.trackBy)&&"$"!=a?F(a)?this.trackByFn=a:this.trackByFn=function(b){return b&&!va(b)?b[a]:void 0}:this.trackByFn=function(a){return va(a)?a:void 0});return this.trackByFn},scopeGetRawIndex:function(a){if(void 0===a)return-1;var b=this.watcher.getUnfilteredValue(),
...
b){var c=this,d=c.node,g=a.params;A(d,"enter",function(){var h=b||[],f={destroyEl:!1,node:d,scope:a.$isolateScope?c.scope.$newIsolated():c.scope.$new()},l,m;a.as&&(f.as=a.as);a.template&&(f.template=a.template);h.shift();if(g)for(l=-1,m=g.length;++l<m;f[g[l]]=h[l]);return da(a.cmp||"MetaphorJs.Component",f,f.scope,d,null,h).done(function(a){c.currentComponent=a})},!0)},setComponent:function(a){var b=this,c=b.node;A(c,"enter",function(){var d=Ga(a)?a:{},g=(C(a)?a:null)||"MetaphorJs.Component",h=d.scope||
b.scope.$new();d.destroyEl=!1;return da(g,d,h,c).done(function(a){b.currentComponent=a})},!0)},destroy:function(){this.clearComponent();this.route&&(sa.un("locationchange",this.onLocationChange,this),this.route=null);this.watchable&&(this.watchable.unsubscribeAndDestroy(this.onCmpChange,this),this.watchable=null);this.currentComponent=this.scope=null;this.$super()}});n.registerAttribute("mjs-app",100,X);var qb=function(){var a=document.createElement("div");return C(a.textContent)?"textContent":"innerText"}();
n.registerAttribute("mjs-bind",1E3,q({$extends:n,isInput:!1,input:null,lockInput:null,recursive:!1,textRenderer:null,$init:function(a,b,c){var d=D(b,a);this.isInput=Ka(b);this.recursive=d.recursive||null!==x(b,"mjs-recursive");this.lockInput=d.lockInput;b.removeAttribute("mjs-recursive");this.isInput&&(this.input=new qa(b,this.onInputChange,this));this.recursive?(this.scope=a,this.node=b,this.textRenderer=new Sa(a,"{{"+c+"}}",null,null,!0),this.textRenderer.subscribe(this.onTextRendererChange,this),
this.onTextRendererChange(),a instanceof J&&a.$on("destroy",this.onScopeDestroy,this)):this.$super(a,b,c)},onInputChange:function(){if(this.lockInput)this.onChange()},onTextRendererChange:function(){this.updateElement(this.textRenderer.getString())},onChange:function(){var a=this.watcher.getLastResult();this.updateElement(a)},updateElement:function(a){this.isInput?this.input.setValue(a):this.node[qb]=a},destroy:function(){this.textRenderer&&(this.textRenderer.$destroy(),this.textRenderer=null);this.input&&
(this.input.destroy(),this.input=null);this.$super()}}));n.registerAttribute("mjs-bind-html",1E3,q({$extends:"attr.mjs-bind",updateElement:function(a){this.node.innerHTML=a}}));(function(){var a=function(a,c,d,g){if(null!==d){if(d==xa(a,c))return;d=!d}else d=xa(a,c);d?g?A(a,[c+"-remove"],null,!0).done(function(){U(a,c)}):U(a,c):g?A(a,[c+"-add"],null,!0).done(function(){ya(a,c)}):ya(a,c)};n.registerAttribute("mjs-class",1E3,q({$extends:n,initial:!0,onChange:function(){var b=this.node,c=this.watcher.getLastResult(),
d=this.watcher.getPrevValue(),g;la(b);if(C(c))d&&a(b,d,!1,!1),a(b,c,null,!this.initial);else if(B(c))for(g=-1,d=c.length;++g<d;a(b,c[g],!0,!this.initial));else for(g in c)a(b,g,c[g]?!0:!1,!this.initial);this.initial=!1}}))})();n.registerAttribute("mjs-cmp-prop",200,["$parentCmp","$node","$attrValue",function(a,b,c){a&&(a[c]=b)}]);(function(){var a=function(a,c,d,g){var h,f,l,m,t,n=D(c,a);d=d.split(" ");l=0;for(m=d.length;l<m;l++)t=d[l],""!=t&&"as"!=t&&(h?f=t:h=t);g=u({scope:a,node:c,as:f,parentRenderer:g,
destroyScope:!0},n,!1,!1);f=V(h,!0);da(h,g,a,c);return!!f.$shadow};a.$breakScope=!0;n.registerAttribute("mjs-cmp",200,a)})();n.registerAttribute("mjs-config",50,function(a,b,c){D(b,a,c)});n.registerAttribute("mjs-each",100,Va);var Da=Ua.createFunc,ea=function(a){if(a instanceof ea)return a;if(!(this instanceof ea))return new ea(a);for(var b in a)if(!this[b])try{this[b]=a[b]}catch(c){}this.originalEvent=a;this.type=a.type;!this.target&&a.srcElement&&(this.target=a.srcElement);var d,g=a.button;void 0===
...
this.stopPropagation()}},!0,!1);(function(){var a="click dblclick mousedown mouseup mouseover mouseout mousemove keydown keyup keypress submit focus blur copy cut paste enter".split(" "),b,c;b=0;for(c=a.length;b<c;b++)(function(a){var b=a;"enter"==b&&(b="keyup");n.registerAttribute("mjs-"+a,1E3,function(c,f,l){var m=Da(l);Y(f,b,function(b){b=La(b||window.event);if("enter"==a&&13!=b.keyCode)return null;c.$event=b;m(c);c.$event=null;c.$root.$check();b.preventDefault();return!1})})})(a[b])})();n.registerAttribute("mjs-show",
...
a.name);a.disabled&&b.setAttribute("disabled","disabled");d.appendChild(b)},render:function(a){var b=this.node,c=Fb(b),d=this.defOption,g=this.scope.$new(),h=na(),f,l,m,n;this.fragment=document.createDocumentFragment();for(this.groupEl=this.prevGroup=null;b.firstChild;)b.removeChild(b.firstChild);m=0;for(n=a.length;m<n;m++)this.renderOption(a[m],m,g);d&&b.insertBefore(d,b.firstChild);g.$destroy();h&&8>h&&(l=b.nextSibling,f=b.parentNode,f.removeChild(b));b.appendChild(this.fragment);this.fragment=
null;h&&8>h&&f.insertBefore(b,l);Gb(b,c)},parseExpr:function(a){var b=a.indexOf(" in "),c;-1==b?(c=a,a="{name: .item, value: .$index}"):(c=a.substr(b+4),a=a.substr(0,b));this.model=c;this.getterFn=wa(a)}}));(function(){var a="selected checked disabled readonly open required".split(" "),b,c,d=q({$extends:n,propName:null,$init:function(a,b,c,d){this.propName=d;this.$super(a,b,c)},onChange:function(a){var b=this.propName;a?this.node.setAttribute(b,b):this.node.removeAttribute(b)}});b=0;for(c=a.length;b<
c;b++)(function(a){n.registerAttribute("mjs-"+a,1E3,function(b,c,f){return new d(b,c,f,a)})})(a[b])})();var rb=function(){var a={},b=0;return function(c){if(a[c])return w.resolve(c);1E3<b&&(a={},b=0);var d=document.createElement("img"),g=d.style,f=new w;Y(d,"load",function(){a[c]=!0;b++;document.body.removeChild(d);f.resolve(c)});g.position="absolute";g.visibility="hidden";g.left="-10000px";g.top="0";d.src=c;document.body.appendChild(d);return f}}();n.registerAttribute("mjs-src",1E3,q({$extends:n,
queue:null,usePreload:!0,$constructor:function(a,b,c){D(b,a).deferred&&this.$plugins.push("SrcDeferred");this.$super(a,b,c)},$init:function(a,b,c){D(b,a).noPreload&&(this.usePreload=!1);this.queue=new y({auto:!0,async:!0,mode:y.ONCE,thenable:!0});this.$super(a,b,c)},onChange:function(){this.queue.add(this.doChange,this)},doChange:function(){var a=this,b=a.watcher.getLastResult();if(a.usePreload)return rb(b).done(function(){a&&a.node&&ma(function(){a.node.src=b;a.node.setAttribute("src",b)})});a.node.src=
b;a.node.setAttribute("src",b)},destroy:function(){this.queue.destroy();this.$super()}}));n.registerAttribute("mjs-transclude",1E3,function(a,b){return Ma(b)});n.registerAttribute("mjs-view",200,function(a,b,c){da(c||"MetaphorJs.View",{scope:a,node:b},a,b);return!1});n.registerTag("mjs-include",function(a,b,c,d){return(new W({scope:a,node:b,tpl:x(b,"src"),parentRenderer:d,replace:!0})).initPromise});n.registerTag("mjs-transclude",function(a,b){return Ma(b)});var sb=function(){var a=function(a,b,c){if(F(b))return b(a,
c);if(""===b||void 0===b)return!0;if(void 0!==a){if(ia(a))return a===b;if(b instanceof RegExp)return b.test(""+a);if("strict"==c)return""+a===""+b;if(!0===c||null===c||void 0===c)return-1!=""+a.indexOf(b);if(!1===c)return-1==""+a.indexOf(b)}return!1},b=function(b,c,f){if(va(b))return void 0===c.$?!0:a(b,c.$,f);var k,l;for(k in c)if("$"==k)for(l in b){if(a(b[l],c.$,f))return!0}else if(a(b[k],c[k],f))return!0;return!1},c=function(a,c,f){S(c)||(c={$:c});var k=[],l,m;l=-1;for(m=a.length;++l<m;)b(a[l],
c,f)&&k.push(a[l]);return k};c.compare=b;return c}();p("filter.filter",function(a,b,c,d){return sb(a,c,d)});p("filter.join",function(a,b,c){c=c||", ";return a&&a.length?(B(a)||(a=M(a)),a.join(c)):""});p("filter.l",function(a,b){return b.$app.lang.get(a)});p("filter.limitTo",function(a,b,c){b=C(a);if(!B(a)&&!b)return a;c=Infinity===Math.abs(Number(c))?Number(c):parseInt(c,10);if(b)return c?0<=c?a.slice(0,c):a.slice(c,a.length):"";b=[];var d;c>a.length?c=a.length:c<-a.length&&(c=-a.length);0<c?d=0:
(d=a.length+c,c=a.length);for(;d<c;d++)b.push(a[d]);return b});p("filter.linkify",function(a,b,c){return a?a.replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig,'<a href="$1"'+(c?' target="'+c+'"':"")+">$1</a>"):""});p("filter.lowercase",function(a){return a.toLowerCase()});var tb={};p("filter.moment",function(a,b,c){c=tb[c]||c;return moment(a).format(c)});var ub={};p("filter.numeral",function(a,b,c){c=ub[c]||c;return numeral(a).format(c)});p("filter.p",function(a,
b,c){return b.$app.lang.plural(a,parseInt(c,10)||0)});p("filter.sortBy",function(a,b,c,d){return db(a,c,d)});p("filter.split",function(a,b,c,d){d=d||void 0;c=c||"/\\n|,/";if(!a)return[];a=""+a;"/"==c.substr(0,1)&&"/"==c.substr(c.length-1)&&(c=Ia(c.substring(1,c.length-1)));a=a.split(c,d);b=-1;for(c=a.length;++b<c;a[b]=aa(a[b]));return a});p("filter.toArray",function(a){return M(a)});p("filter.ucfirst",function(a){return a.substr(0,1).toUpperCase()+a.substr(1)});p("filter.uppercase",function(a){return a.toUpperCase()});
var vb=function(){return function b(c,d){if(c===d)return!0;if(null===c||null===d)return!1;if(c!==c&&d!==d)return!0;var g=typeof c,f;if(g==typeof d&&"object"==g)if(B(c)){if(!B(d))return!1;if((g=c.length)==d.length){for(f=0;f<g;f++)if(!b(c[f],d[f]))return!1;return!0}}else{if(Aa(c))return Aa(d)&&c.getTime()==d.getTime();if(Ba(c)&&Ba(d))return c.toString()==d.toString();if(Na(c)||Na(d)||B(d))return!1;g={};for(f in c)if("$"!=f.charAt(0)&&!F(c[f])){if(!b(c[f],d[f]))return!1;g[f]=!0}for(f in d)if(!g.hasOwnProperty(f)&&
"$"!=f.charAt(0)&&void 0!==d[f]&&!F(d[f]))return!1;return!0}return!1}}(),Ib=function(){var a={};return function(b){if(void 0===a[b]){if("input"==b&&9==na())return a[b]=!1;var c=document.createElement("div");a[b]=!!("on"+b in c)}return a[b]}}(),Jb=function(){var a=parseInt((/android (\d+)/.exec(Ea)||[])[1],10)||!1;return function(){return a}}(),Kb=function(){var a="undefined"!=typeof window?window:null,b="undefined"!=typeof global?global:null;return function d(g,f){if(a&&g===a)throw Error("Cannot copy window object");
if(b&&g===b)throw Error("Cannot copy global object");if(f){if(g===f)throw Error("Objects are identical");if(B(g))for(var k=f.length=0,l=g.length;k<l;k++)f.push(d(g[k]));else{for(k in f)delete f[k];for(k in g)g.hasOwnProperty(k)&&("$"==k.charAt(0)||F(g[k])?f[k]=g[k]:f[k]=d(g[k]))}}else(f=g)&&(B(g)?f=d(g,[]):Aa(g)?f=new Date(g.getTime()):Ba(g)?f=new RegExp(g.source):S(g)&&(f=d(g,{})));return f}}(),Qa=ra.is,oa={},O=function(){return window.getComputedStyle?function(a,b,c){if(a===window)return b?c?0:
null:{};a=getComputedStyle(a,null);b=b?a[b]:a;return c?parseFloat(b)||0:b}:function(a,b,c){a=a.currentStyle||a.style||{};b=b?a[b]:a;return c?parseFloat(b)||0:b}}(),wb=function(){var a;return function(){if(void 0===a){var b=document.createElement("div"),c=document.createElement("div"),d=document.body;c.style&&window.getComputedStyle?(b.style.cssText="border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute",b.appendChild(c),c.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute",
c.innerHTML="",d.appendChild(b),c="4px"===window.getComputedStyle(c,null).width,d.removeChild(b),a=c):a=!1}return a}}(),ca=function(a,b){var c=/^([+-]?(?:d*.|)d+(?:[eE][+-]?d+|))(?!px)[a-z%]+$/i,d=["Top","Right","Bottom","Left"],f=a?"inner"==a?"padding":"":"content";return function(a,k){if(a===window)return a.document.documentElement["client"+b];if(9===a.nodeType){var l=a.documentElement;return Math.max(a.body["scroll"+b],l["scroll"+b],a.body["offset"+b],l["offset"+b],l["client"+b])}a:{var m=b.toLowerCase(),
n=f||(!0===k?"margin":"border"),l=O(a),q=!0,s="width"===m?a.offsetWidth:a.offsetHeight,p="border-box"===l.boxSizing;if(0>=s||null==s){s=a.style[m];if(c.test(s)){l=s;break a}q=p&&(wb()||s===a.style[m]);s=parseFloat(s)||0}n=n||(p?"border":"content");m=n===(q?"border":"content")?4:"width"===m?1:0;for(p=0;4>m;m+=2)"margin"===n&&(p+=parseFloat(l[n+d[m]])),q?("content"===n&&(p-=parseFloat(l["padding"+d[m]])),"margin"!==n&&(p-=parseFloat(l["border"+d[m]+"Width"]))):(p+=parseFloat(l["padding"+d[m]]),"padding"!==
n&&(p+=parseFloat(l["border"+d[m]+"Width"])));l=s+p}return l}},Lb=ca("","Height"),Mb=ca("inner","Height"),Nb=ca("inner","Width"),Wa=function(a){var b,c=a?"pageYOffset":"pageXOffset",d=a?"scrollTop":"scrollLeft";a=document;var f=a.body,h=a.documentElement;b=void 0!==window[c]?function(){return window[c]}:h.clientHeight?function(){return h[d]}:function(){return f[d]};return function(a){return a&&a!==window?a&&1==a.nodeType&&a!==f&&a!==h?a[d]:b():b()}},eb=Wa(!0),fb=Wa(!1),Ob=ca("outer","Height"),Pb=
ca("outer","Width"),Qb=function(){var a=/(auto|scroll)/,b,c=function(a){a=O(a);return a.overflow+a.overflowY+a.overflowY};return function(d){b||(b=document.body);for(;d&&d!==b;){if(a.test(c(d)))return d;d=d.parentNode}return window}}(),Rb=ca("","Width"),pa=require("fs"),xb=function(a){return pa.existsSync(a)&&pa.lstatSync(a).isFile()},Xa=function(a){return pa.existsSync(a)&&pa.lstatSync(a).isDirectory()},Ya=require("path"),Sb=function(){var a=Object.prototype.toString,b=Function.prototype.toString,
c=/^\[object .+?Constructor\]$/,d=RegExp("^"+String(a).replace(/[.*+?^${}()|[\]\/\\]/g,"\\$&").replace(/toString|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");return function(f){var h=typeof f;return"function"==h?!("prototype"in f)||d.test(b.call(f)):f&&"object"==h&&c.test(a.call(f))||!1}}(),Tb=function(){return"undefined"!=typeof JSON?function(a){return JSON.parse(a)}:function(a){return(new Function("return "+a))()}}(),yb=Va.$extend({store:null,$constructor:function(a,b,c){var d=D(b,a);
d.pullNext&&(d.buffered&&(d.bufferedPullNext=!0,d.buffered=!1),this.$plugins.push("ListPullNext"));this.$super(a,b,c)},afterInit:function(a,b,c){this.store=a=wa(this.model)(a);this.watcher=P(a,".current",this.onChange,this,null,E);this.trackByFn=ba(a.getRecordId,a);this.griDelegate=ba(a.indexOfId,a);this.bindStore(a,"on")},bindStore:function(a,b){a[b]("update",this.onStoreUpdate,this);a[b]("clear",this.onStoreUpdate,this);a[b]("destroy",this.onStoreDestroy,this)},onStoreUpdate:function(){this.watcher.check()},
getListItem:function(a,b){return this.store.getRecordData(a[b])},onStoreDestroy:function(){this.onStoreUpdate();this.watcher.unsubscribeAndDestroy(this.onChange,this);this.watcher=null},destroy:function(){this.bindStore(this.store,"un");this.$super()}},{$stopRenderer:!0,$registerBy:"id"});n.registerAttribute("mjs-each-in-store",100,yb);q({$class:"DialogComponent",$extends:ob,dialog:null,dialogPreset:null,dialogCfg:null,initComponent:function(){this.$super();this._createDialog();this._oldShow=this.show;
this._oldHide=this.hide},_getDialogCfg:function(){return u({},this.dialogCfg,{render:{el:this.node,keepInDOM:!0}},!0,!0)},_createDialog:function(){this.dialog=new Db(this.dialogPreset,this._getDialogCfg());this.dialog.on("show",this._oldShow,this);this.dialog.on("hide",this._oldHide,this);this.dialog.on("destroy",this.onDialogDestroy,this)},show:function(){this.dialog.show()},hide:function(){this.dialog.hide()},onDialogDestroy:function(){this.destroying||(this.dialog=null,this.$destroy())},destroy:function(){this.destroying=
!0;this.dialog&&this.dialog.destroy();this.$super()}});q({$class:"MetaphorJs.ValidatorComponent",node:null,scope:null,validator:null,scopeState:null,$init:function(a,b,c){this.node=a;this.scope=b;this.scopeState={};this.validator=this.createValidator();this.initScope();this.initScopeState();this.initValidatorEvents();c.once("rendered",this.validator.check,this.validator)},createValidator:function(){var a=this.node,b={},c;if(c=D(a).submit)b.callback=b.callback||{},b.callback.submit=function(a,b){return function(){try{return a(b)}catch(c){K(c)}}}(Da(c),
this.scope);return new Cb(a,b)},initValidatorEvents:function(){var a=this.validator;a.on("fieldstatechange",this.onFieldStateChange,this);a.on("statechange",this.onFormStateChange,this);a.on("displaystatechange",this.onDisplayStateChange,this);a.on("reset",this.onFormReset,this)},initScope:function(){var a=this.scope,b=this.node,b=x(b,"name")||x(b,"id")||"$form";a[b]=this.scopeState},initScopeState:function(){var a=this.node,b=this.scopeState,c,d,f;a.elements?c=a.elements:(c=[],Oa(a,function(a){Ka(a)&&
c.push(a)}));a=-1;for(f=c.length;++a<f;)d=c[a],(d=x(d,"name")||x(d,"id"))&&!b[d]&&(b[d]={$error:null,$invalid:null,$pristine:!0,$errorMessage:null});b.$invalid=!1;b.$pristine=!0;b.$submit=ba(this.validator.onSubmit,this.validator);b.$reset=ba(this.validator.reset,this.validator);window.formState=b},onDisplayStateChange:function(a,b){if(b){b=this.scopeState;var c,d;for(c in b)d=b[c],d.$real&&(b[c]=d.$real);b.$invalid=!a.isValid();b.$pristine=!1;this.scope.$check()}else this.onFormReset(a)},onFormReset:function(a){a=
...
a?d[f]=b:d[f].$real=b;this.scope.$check()}});n.registerAttribute("mjs-validate",250,["$scope","$node","$attrValue","$renderer",function(a,b,c,d){c=c||"MetaphorJs.ValidatorComponent";var f=V(c);f?new f(b,a,d):K(Error("Class '"+c+"' not found"))}]);f.ns=E;f.cs=jb;f.defineClass=q;f.emptyFn=H;f.slice=Z;f.getAttr=x;f.undf=void 0;f.varType=Q;f.isPlainObject=S;f.isBool=ia;f.extend=u;f.Scope=J;f.nextUid=L;f.isArray=B;f.toArray=M;f.isFunction=F;f.isThenable=T;f.nsGet=V;f.isString=C;f.nodeTextProp=Ra;f.trim=
aa;f.createWatchable=P;f.nsAdd=p;f.Directive=n;f.bind=ba;f.isNull=function(a){return null===a};f.TextRenderer=Sa;f.setAttr=function(a,b,c){return a.setAttribute(b,c)};f.removeAttr=function(a,b){return a.removeAttribute(b)};f.getAttrMap=Za;f.aIndexOf=Ca;f.Renderer=ga;f.Text=kb;f.ObservableMixin=Ta;f.isObject=Ga;f.instantiate=lb;f.Provider=Ja;f.ProviderMixin=mb;f.documentElement=I;f.isAttached=fa;f.data=G;f.toFragment=N;f.clone=za;f.shadowRootSupported=nb;f.Template=W;f.Component=ob;f.getRegExp=Ia;
f.getClsReg=Ha;f.removeClass=U;f.stopAnimation=la;f.async=ta;f.isNumber=ua;f.strUndef="undefined";f.error=K;f.Queue=y;f.isPrimitive=va;f.raf=ma;f.functionFactory=Ua;f.createGetter=wa;f.toCamelCase=$a;f.getNodeData=ab;f.getNodeConfig=D;f.ListRenderer=Va;f.hasClass=xa;f.addClass=ya;f.resolveComponent=da;f.currentUrl=pb;f.returnFalse=X;f.isField=Ka;f.elemTextProp=qb;f.createFunc=Da;f.returnTrue=ja;f.DomEvent=ea;f.normalizeEvent=La;f.addListener=Y;f.uaString=Ea;f.isIE=na;f.preloadImage=rb;f.parentData=
cb;f.transclude=Ma;f.filterArray=sb;f.dateFormats=tb;f.numberFormats=ub;f.sortArray=db;f.inArray=function(a,b){return b?-1!=Ca.call(b,a):!1};f.isDate=Aa;f.isRegExp=Ba;f.isWindow=Na;f.equals=vb;f.levenshteinArray=function(a,b){var c=a.length,d=b.length,f=Array(c+1),h=Array(c+1),k,l,m,n,p=0;if(c==d&&0==c)return{changes:0,distance:0,prescription:[]};for(k=0;k<=c;k++)f[k]=Array(d+1),h[k]=Array(d+1),f[k][0]=k,h[k][0]="D";for(k=0;k<=d;k++)f[0][k]=k,h[0][k]="I";for(k=1;k<=c;k++)for(l=1;l<=d;l++)m=vb(a[k-
1],b[l-1])?0:1,f[k][l-1]<f[k-1][l]&&f[k][l-1]<f[k-1][l-1]+m?(f[k][l]=f[k][l-1]+1,h[k][l]="I"):f[k-1][l]<f[k-1][l-1]+m?(f[k][l]=f[k-1][l]+1,h[k][l]="D"):(f[k][l]=f[k-1][l-1]+m,h[k][l]=1==m?"R":"-");n=[];k=c;l=d;do m=h[k][l],n.push(m),"-"!=m&&p++,"R"==m||"-"==m?(k--,l--):"D"==m?k--:l--;while(0!=k||0!=l);return{changes:p/n.length,distance:f[c][d],prescription:n.reverse()}};f.browserHasEvent=Ib;f.isAndroid=Jb;f.compile=function(a,b){var c=document.createElement("div");c.innerHTML=a;c=N(c.childNodes);
(new ga(c,b)).process();return c};f.copy=Kb;f.is=Qa;f.delegates=oa;f.delegate=function(a,b,c,d){var f=b+"-"+c,h=function(a){a=La(a);return Qa(a.target,b)?d(a):null};oa[f]||(oa[f]=[]);oa[f].push({el:a,ls:h,fn:d});Y(a,c,h)};f.eachNode=Oa;f.getStyle=O;f.boxSizingReliable=wb;f.getDimensions=ca;f.getHeight=Lb;f.getInnerHeight=Mb;f.getInnerWidth=Nb;f.getScrollTopOrLeft=Wa;f.getScrollTop=eb;f.getScrollLeft=fb;f.getOffset=ka;f.getOffsetParent=gb;f.getOuterHeight=Ob;f.getOuterWidth=Pb;f.getPosition=function(a,
b){var c,d,f={top:0,left:0};if(a===window||a===I)return f;if("fixed"==O(a,"position"))d=a.getBoundingClientRect();else{if(b)return c=ka(a),d=ka(b),c={left:c.left-d.left,top:c.top-d.top},0>c.left&&(c.left=0),0>c.top&&(c.top=0),c;c=gb(a);d=ka(a);c!==I&&(f=ka(c));f.top+=O(c,"borderTopWidth",!0);f.left+=O(c,"borderLeftWidth",!0)}return{top:d.top-f.top-O(a,"marginTop",!0),left:d.left-f.left-O(a,"marginLeft",!0)}};f.getScrollParent=Qb;f.getWidth=Rb;f.isSubmittable=function(a){var b=a.type?a.type.toLowerCase():
"";return"input"==a.nodeName.toLowerCase()&&"radio"!=b&&"checkbox"!=b};f.isVisible=function(a){return!(0>=a.offsetWidth||0>=a.offsetHeight)};f.removeListener=Pa;f.onReady=hb;f.undelegate=function(a,b,c,d){var f,h;if(h=oa[b+"-"+c])for(b=-1,f=h.length;++b<f;)h[b].el===a&&h[b].fn===d&&Pa(a,c,h[b].ls)};f.isFile=xb;f.isDir=Xa;f.getFileList=function(a){var b,c,d=0,f=[];"*"==a.substr(a.length-1)&&d++;"**"==a.substr(a.length-2)&&d++;d&&(a=a.substr(0,a.length-(d+1)));a=Ya.normalize(a);var h=function(a){b=
pa.readdirSync(a);b.forEach(function(b){c=Ya.normalize(a+"/"+b);xb(c)&&".js"==Ya.extname(c)?f.push(c):Xa(c)&&1<d&&h(c)})};0<d||Xa(a)?h(a):f=[a];return f};f.initApp=ib;f.intercept=function(a,b,c,d,f,h){f=f||"before";return function(){var k,l;if("instead"==f)return b.apply(c||d,arguments);"before"==f?(k=b.apply(c||d,arguments),l=!1!==k?a.apply(d||c,arguments):null):(l=a.apply(d||c,arguments),k=b.apply(c||d,arguments));return h?k:l}};f.isInjectable=function(a){return a&&(a.length&&F(a[a.length-1])||
a.inject)};f.isNative=Sb;f.isUndefined=function(a){return"undefined"==typeof a};f.parseJSON=Tb;f.parseXML=function(a,b){var c,d;if(!a||!C(a))return null;try{d=new DOMParser,c=d.parseFromString(a,b||"text/xml")}catch(f){c=void 0}if(!c||c.getElementsByTagName("parsererror").length)throw"Invalid XML: "+a;return c};f.run=function(){hb(function(){var a=ra("[mjs-app]"),b,c,d;b=-1;for(c=a.length;++b<c;)d=a[b],ib(d,x(d,"mjs-app"),null,!0)})};f.ucfirst=function(a){return a.substr(0,1).toUpperCase()+a.substr(1)};
f.StoreRenderer=yb;return f});
