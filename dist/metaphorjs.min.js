...
b.trim():b}:function(b){return"string"==typeof b?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}(),z=Array.prototype.indexOf,v=Object.prototype.toString,C=Object.prototype.hasOwnProperty,B=function(b){return b&&"object"==typeof b&&"number"==typeof b.length&&"[object Array]"==v.call(b)||!1},y=function(b){var m,a,k;if(B(b)){k=[];m=0;for(a=b.length;m<a;m++)k.push(y(b[m]));return k}switch(b.nodeType){case 1:return b.cloneNode(!0);case 3:return document.createTextNode(b.innerText||b.textContent);case 11:return b.cloneNode(!0);
...
return this},then:function(b,k){var d=new c,f=this._state;0==f||0!=this._wait?(b&&"function"==typeof b?this._fulfills.push([a(b,d),null]):this._fulfills.push([d.resolve,d]),k&&"function"==typeof k?this._rejects.push([a(k,d),null]):this._rejects.push([d.reject,d])):1==f?b&&"function"==typeof b?g(a(b,d),null,[this._value]):d.resolve(this._value):2==f&&(k&&"function"==typeof k?g(a(k,d),null,[this._reason]):d.reject(this._reason));return d},"catch":function(b){return this.then(null,b)},_done:function(){for(var b=
...
this),done:q(this.done,this),fail:q(this.fail,this),always:q(this.always,this)}},after:function(b){var a=this;if(p(b)){a._wait++;var c=function(){a._wait--;0==a._wait&&0!=a._state&&(1==a._state?a._callResolveHandlers():a._callRejectHandlers())};"function"==typeof b.done?b.done(c):b.then(c)}return a}});l(c,{resolve:function(b){if(p(b)||"function"==typeof b)return new c(b);var a=new c;a.resolve(b);return a},reject:function(b){var a=new c;a.reject(b);return a},all:function(b){if(!b.length)return c.resolve(null);
var a=new c,d=b.length,f=[],e=d,g,l,h=function(b){f.push(b);e--;0==e&&a.resolve(f)};for(g=0;g<d;g++)l=b[g],l instanceof c?l.done(h).fail(a.reject,a):p(l)||"function"==typeof l?(new c(l)).done(h).fail(a.reject,a):h(l);return a},when:function(){return c.all(arguments)},allResolved:function(b){if(!b.length)return c.resolve(null);var a=new c,d=b.length,f=[],e=d,g,l,h=function(b){f.push(b);n()},n=function(){e--;0==e&&a.resolve(f)};for(g=0;g<d;g++)l=b[g],l instanceof c?l.done(h).fail(n):p(l)||"function"==
typeof l?(new c(l)).done(h).fail(n):h(l);return a},race:function(b){if(!b.length)return c.resolve(null);var a=new c,d=b.length,f,e;for(f=0;f<d&&(e=b[f],e instanceof c?e.done(a.resolve,a).fail(a.reject,a):p(e)||"function"==typeof e?(new c(e)).done(a.resolve,a).fail(a.reject,a):a.resolve(e),a.isPending());f++);return a}});"undefined"==typeof global?(window.Promise||(window.Promise=c),window.MetaphorJs&&window.MetaphorJs.r("MetaphorJs.lib.Promise",c)):"undefined"!=typeof module&&(module.exports=c)})();
...
for(var f=0,e=c.length;f<e;f++)if(c[f].id==d)return!0;return!1}return 0<c.length},removeAllListeners:function(){var b=this.listeners,a=this.uni,c,d;c=0;for(d=b.length;c<d;c++)delete b[c].uniScope[a];this.listeners=[];this.map={}},suspend:function(){this.suspended=!0},resume:function(){this.suspended=!1},_prepareArgs:function(a,c){var d;a.append||a.prepend?(d=e.call(c),a.prepend&&(d=a.prepend.concat(d)),a.append&&(d=d.concat(a.append))):d=c;return d},triggerAsync:function(){if("undefined"==typeof n)throw Error("Promises are not defined");
var a=this,c=a.listeners,f=a.returnResult,g=e.call(arguments),l=[],h=[],p,v,C;if(a.suspended||0==c.length)return n.resolve(null);v=0;for(C=c.length;v<C;v++)l.push(c[v]);for(v=function(c){p=a._prepareArgs(c,g);return new n(function(f,e){d(function(){try{f(c.fn.apply(c.scope,p))}catch(d){e(d)}c.called++;c.called==c.limit&&a.un(c.id)},0)})};(c=l.shift())&&(!c||!a.map[c.id]||(c.count++,c.count<c.start||(h.push(v(c)),"first"!=f))););return"last"==f?[h.pop()]:h},trigger:function(){var a=this.listeners,
c=this.returnResult;if(this.suspended||0==a.length)return null;var d="all"==c?[]:null,f=[],e,g;if("first"==c)f.push(a[0]);else for(e=0,g=a.length;e<g;e++)f.push(a[e]);for(;a=f.shift();)if(a&&this.map[a.id]&&(a.count++,!(a.count<a.start))){e=a.fn.apply(a.scope,this._prepareArgs(a,arguments));a.called++;a.called==a.limit&&this.un(a.id);"all"==c&&d.push(e);if("first"==c)return e;"last"==c&&(d=e);if(!1==c&&!1===e)break}if(c)return d}});var a=window.MetaphorJs;if(a&&a.VERSION){var c=new g;h(MetaphorJs,
...
k.charAt(0)||"object"!=typeof c[k])&&"function"!==typeof c[k]){if(!b(c[k],d[k]))return!1;e[k]=!0}for(k in d)if(!e.hasOwnProperty(k)&&"$"!==k.charAt(0)&&void 0!==d[k]&&"function"!==typeof d[k])return!1;return!0}return!1},k=function(a,c){var d=a.length,e=c.length,f=Array(d+1),k=Array(d+1),m,u,g,l,h=0;if(d==e&&0==d)return{changes:0,distance:0,prescription:[]};for(m=0;m<=d;m++)f[m]=Array(e+1),k[m]=Array(e+1),f[m][0]=m,k[m][0]="D";for(m=0;m<=e;m++)f[0][m]=m,k[0][m]="I";for(m=1;m<=d;m++)for(u=1;u<=e;u++)g=
b(a[m-1],c[u-1])?0:1,f[m][u-1]<f[m-1][u]&&f[m][u-1]<f[m-1][u-1]+g?(f[m][u]=f[m][u-1]+1,k[m][u]="I"):f[m-1][u]<f[m-1][u-1]+g?(f[m][u]=f[m-1][u]+1,k[m][u]="D"):(f[m][u]=f[m-1][u-1]+g,k[m][u]=1==g?"R":"-");l=[];m=d;u=e;do g=k[m][u],l.push(g),"-"!=g&&h++,"R"==g||"-"==g?(m--,u--):"D"==g?m--:u--;while(0!=m||0!=u);return{changes:h/l.length,distance:f[d][e],prescription:l.reverse()}},s=window.MetaphorJs?MetaphorJs.trim:function(){return String.prototype.trim?function(a){return"string"==typeof a?a.trim():
...
c(this.obj);break;case "array":a=this.obj}f(a)&&(a=a.slice());var d=this.pipes;if(d){var e,k,g,m=d.length,u=this.obj,l,h;for(e=0;e<m;e++){g=d[e][1];k=[];l=-1;for(h=g.length;++l<h;k.push(G(g[l],u)));k.unshift(a);k.push(u);a=d[e][0].apply(null,k)}}return a},addListener:function(a,b,c){return r.on(this.id,a,b,c)},removeListener:function(a,b){return r.un(this.id,a,b)},getValue:function(){return this._getValue()},setValue:function(a){var b=this.type;if("attr"==b)this.obj[this.code]=a;else if("expr"==b)this.setterFn||
...
0;var g=(m[h]||"").split(","),l=(m[q]||"").split(","),k=(m[d]||"").split(","),m=(m[e]||"").split(",");b=Math.max(b,x(b,g,l));(b=Math.max(b,x(b,k,m)))?s(w,(new Date).getTime(),b):w()}},K=function(){if(!A()){z(a,c[f]);var b;g&&(b=g(a),g=null);k(b)?b.done(H):l(H)}};p?l(K):K()},z=MetaphorJs.addClass,v=MetaphorJs.removeClass;MetaphorJs.stopAnimation=function(a){var c=b(a,"mjsAnimationQueue"),d;c&&c.length&&(d=c[0])&&d.stages&&(c=d.position,d=d.stages,v(a,d[c]),v(a,d[c]+"-active"));b(a,"mjsAnimationQueue",
null)};MetaphorJs.animate=function(d,e,l){var h=d.getAttribute("mjs-animate"),v=d.getAttribute("mjs-animate-js"),p=new c,q=b(d,"mjsAnimationQueue")||[],r=++f,s,x;e&&"string"==typeof e&&(e=n[e]);"string"==typeof h&&h&&"["==h.substr(0,1)&&(e=(new Function("","return "+h))(),h=null);q.push({el:d,stages:e,start:l,deferred:p,position:0,id:r});b(d,"mjsAnimationQueue",q);void 0!=h&&g&&e?1==q.length&&t(d,e,0,l,p,!0,r):(s=v||h)&&(x=a("animate."+s,!0))?x(d,l,p):l?(e=l(d),k(e)?e.done(function(){p.resolve(d)}):
...
k.renderer.destroy(),v(k.el,"leave").done(function(a){a.parentNode&&a.parentNode.removeChild(a)})),"D"==q?c.splice(e,1):(k=d.cloneNode(!0),v(k,"enter",function(a){return function(d){0<a?f.insertBefore(d,c[a-1].el.nextSibling):b.prevEl?f.insertBefore(d,b.prevEl.nextSibling):f.appendChild(d)}}(e)),"R"==q?c[l]=b.createItem(k,g,e):"I"==q&&(l<c.length?c.splice(l,0,b.createItem(k,g,e)):c.push(b.createItem(k,g,e))),e++));b.doUpdate(g,h)},parseExpr:function(a){a=a.split(" ");var b,c,d,e,f;b=0;for(c=a.length;b<
