 ...
 */
var select = MetaphorJs.dom.select = function dom_select(selector, root) {
        ...
        _processNode: function(node, _attrs) {
            ...
            if (nodeType === nodeCmt) {
                ...
                var tag     = node.tagName.toLowerCase(),
                    ...
                    i, len,
                    j, jlen,
                    attrs = _attrs || dom_getAttrSet(node);
...
cls({
    ...
    $initDirective: function() {
        ...
        self.scrollEl = dom_getScrollParent(self.directive.node);
